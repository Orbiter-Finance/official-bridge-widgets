...
class Wu extends EE {
  ...
  async injectModalUi() {
    if (!al && X.isClient()) {
      if (await import("./basic-CTNSbae4.js"), await import("./w3m-modal-Bs45Unne.js"), !document.querySelector("w3m-modal")) {
