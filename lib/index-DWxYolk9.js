import { t as N, u as V, i as b, r as $, c as S, x as m, v as q, y as B, d as W, e as Y } from "./core-CA7_eCPT.js";
const w = {
...
const U = {
  add: async () => (await import("./add-CpXYa-p0.js")).addSvg,
  allWallets: async () => (await import("./all-wallets-e5RDeqos.js")).allWalletsSvg,
  arrowBottomCircle: async () => (await import("./arrow-bottom-circle-CNA9ImWb.js")).arrowBottomCircleSvg,
  appStore: async () => (await import("./app-store-Brya4311.js")).appStoreSvg,
  apple: async () => (await import("./apple-BhjKpL-Q.js")).appleSvg,
  arrowBottom: async () => (await import("./arrow-bottom-Uv5aDwpj.js")).arrowBottomSvg,
  arrowLeft: async () => (await import("./arrow-left-AoCTK1Uj.js")).arrowLeftSvg,
  arrowRight: async () => (await import("./arrow-right-D1QLK1L-.js")).arrowRightSvg,
  arrowTop: async () => (await import("./arrow-top-VoxN0IUy.js")).arrowTopSvg,
  bank: async () => (await import("./bank-D_C-V32z.js")).bankSvg,
  browser: async () => (await import("./browser-DY_oHI9B.js")).browserSvg,
  card: async () => (await import("./card-CMpD1g_P.js")).cardSvg,
  checkmark: async () => (await import("./checkmark-CMkatufy.js")).checkmarkSvg,
  checkmarkBold: async () => (await import("./checkmark-bold-DirO7wnc.js")).checkmarkBoldSvg,
  chevronBottom: async () => (await import("./chevron-bottom-C1CQ98qj.js")).chevronBottomSvg,
  chevronLeft: async () => (await import("./chevron-left-CuWjRJ2A.js")).chevronLeftSvg,
  chevronRight: async () => (await import("./chevron-right-DuR67bqR.js")).chevronRightSvg,
  chevronTop: async () => (await import("./chevron-top-DPw9tVim.js")).chevronTopSvg,
  chromeStore: async () => (await import("./chrome-store-CcJP1Sf-.js")).chromeStoreSvg,
  clock: async () => (await import("./clock-Cwo8V5gv.js")).clockSvg,
  close: async () => (await import("./close-IQDqhxdG.js")).closeSvg,
  compass: async () => (await import("./compass-atoHeFMg.js")).compassSvg,
  coinPlaceholder: async () => (await import("./coinPlaceholder-M4ciLtG3.js")).coinPlaceholderSvg,
  copy: async () => (await import("./copy-rvlxbfS9.js")).copySvg,
  cursor: async () => (await import("./cursor-FiIyKlMM.js")).cursorSvg,
  cursorTransparent: async () => (await import("./cursor-transparent-D9-47ghR.js")).cursorTransparentSvg,
  desktop: async () => (await import("./desktop-nKYp9e1h.js")).desktopSvg,
  disconnect: async () => (await import("./disconnect-DjObkPbS.js")).disconnectSvg,
  discord: async () => (await import("./discord-KYsgyLUQ.js")).discordSvg,
  etherscan: async () => (await import("./etherscan-CD5Xhdz4.js")).etherscanSvg,
  extension: async () => (await import("./extension-BgMEDA_f.js")).extensionSvg,
  externalLink: async () => (await import("./external-link-C-MobQlZ.js")).externalLinkSvg,
  facebook: async () => (await import("./facebook-D81v5v7r.js")).facebookSvg,
  farcaster: async () => (await import("./farcaster-Cifoa1-h.js")).farcasterSvg,
  filters: async () => (await import("./filters-fc6BTItP.js")).filtersSvg,
  github: async () => (await import("./github-D0I3bXEp.js")).githubSvg,
  google: async () => (await import("./google-DXyWw0Oa.js")).googleSvg,
  helpCircle: async () => (await import("./help-circle-CTjIN3ps.js")).helpCircleSvg,
  image: async () => (await import("./image-C3b4fLV3.js")).imageSvg,
  id: async () => (await import("./id-CoLjtRW3.js")).idSvg,
  infoCircle: async () => (await import("./info-circle-DrMlY96s.js")).infoCircleSvg,
  lightbulb: async () => (await import("./lightbulb-B_M4Ckbn.js")).lightbulbSvg,
  mail: async () => (await import("./mail-DRn4A6ZE.js")).mailSvg,
  mobile: async () => (await import("./mobile-BKggOehM.js")).mobileSvg,
  more: async () => (await import("./more-YSjhG80P.js")).moreSvg,
  networkPlaceholder: async () => (await import("./network-placeholder-pWF3q_hu.js")).networkPlaceholderSvg,
  nftPlaceholder: async () => (await import("./nftPlaceholder-dSBWiSpv.js")).nftPlaceholderSvg,
  off: async () => (await import("./off-D2FzXfGV.js")).offSvg,
  playStore: async () => (await import("./play-store-CtMpucDx.js")).playStoreSvg,
  plus: async () => (await import("./plus-Bc7og-8N.js")).plusSvg,
  qrCode: async () => (await import("./qr-code-22CJjE0p.js")).qrCodeIcon,
  recycleHorizontal: async () => (await import("./recycle-horizontal-MbCizZVN.js")).recycleHorizontalSvg,
  refresh: async () => (await import("./refresh-BuJ57VU1.js")).refreshSvg,
  search: async () => (await import("./search-DQTlGKO0.js")).searchSvg,
  send: async () => (await import("./send-BTda5DTg.js")).sendSvg,
  swapHorizontal: async () => (await import("./swapHorizontal-CIcOWir8.js")).swapHorizontalSvg,
  swapHorizontalMedium: async () => (await import("./swapHorizontalMedium-50JlaQB1.js")).swapHorizontalMediumSvg,
  swapHorizontalBold: async () => (await import("./swapHorizontalBold-DWmVlVFj.js")).swapHorizontalBoldSvg,
  swapHorizontalRoundedBold: async () => (await import("./swapHorizontalRoundedBold-Dp2UXZOj.js")).swapHorizontalRoundedBoldSvg,
  swapVertical: async () => (await import("./swapVertical-BH3XMY5X.js")).swapVerticalSvg,
  telegram: async () => (await import("./telegram-HYU10t1a.js")).telegramSvg,
  threeDots: async () => (await import("./three-dots-DEXEEZ2g.js")).threeDotsSvg,
  twitch: async () => (await import("./twitch-CmsN6lzp.js")).twitchSvg,
  twitter: async () => (await import("./x-DVmM8Uq7.js")).xSvg,
  twitterIcon: async () => (await import("./twitterIcon-CKraMXLO.js")).twitterIconSvg,
  verify: async () => (await import("./verify-utdi_4pC.js")).verifySvg,
  verifyFilled: async () => (await import("./verify-filled-DqBNF3FQ.js")).verifyFilledSvg,
  wallet: async () => (await import("./wallet-OJxgCElY.js")).walletSvg,
  walletConnect: async () => (await import("./walletconnect-CqC8Cj9U.js")).walletConnectSvg,
  walletConnectLightBrown: async () => (await import("./walletconnect-CqC8Cj9U.js")).walletConnectLightBrownSvg,
  walletConnectBrown: async () => (await import("./walletconnect-CqC8Cj9U.js")).walletConnectBrownSvg,
  walletPlaceholder: async () => (await import("./wallet-placeholder-Bk_vADw-.js")).walletPlaceholderSvg,
  warningCircle: async () => (await import("./warning-circle-BVyN4GQA.js")).warningCircleSvg,
  x: async () => (await import("./x-DVmM8Uq7.js")).xSvg,
  info: async () => (await import("./info-uNCz3QUj.js")).infoSvg,
  exclamationTriangle: async () => (await import("./exclamation-triangle-CnIjhGmz.js")).exclamationTriangleSvg,
  reown: async () => (await import("./reown-logo-B-LFcynZ.js")).reownSvg
};
async function pt(e) {
  if (O.has(e))
    return O.get(e);
