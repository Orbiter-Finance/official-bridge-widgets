...
class Wu extends EE {
  ...
  async injectModalUi() {
    if (!al && X.isClient()) {
      if (await import("./basic-CcaQm88R.js"), await import("./w3m-modal-EHImI7Lp.js"), !document.querySelector("w3m-modal")) {
