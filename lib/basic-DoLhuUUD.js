import { i as N, e as G, r as q, c as O, x as c, j as M, m as z, O as ee, o as j, E as te, R as U, z as Me, f as K, B as k, D as ft, q as Ci, W as pt, C as Zt, g as yn, T as en, l as Xe, M as oi, F as ri, b as Ne, v as xn, d as $i } from "./core-BqSxo85B.js";
import { n as u, c as P, o as I, r as _, U as he, e as Ri, f as _i, a as Ei } from "./index-wcFKMsR6.js";
import { o as Ii } from "./index-Cti-Lqot.js";
const Wi = N`
  :host {
    position: relative;
...
_e([
  u()
], fe.prototype, "imageSrc", void 0);
_e([
  u()
], fe.prototype, "walletIcon", void 0);
_e([
  u({ type: Boolean })
], fe.prototype, "installed", void 0);
_e([
  u()
], fe.prototype, "badgeSize", void 0);
fe = _e([
  P("wui-wallet-image")
], fe);
const Si = N`
...
let Ze = class extends O {
  ...
  render() {
    const e = this.walletImages.length < Et;
    return c`${this.walletImages.slice(0, Et).map(({ src: n, walletName: i }) => c`
            <wui-wallet-image
              size="inherit"
              imageSrc=${n}
              name=${I(i)}
...
ai([
  u({ type: Array })
], Ze.prototype, "walletImages", void 0);
Ze = ai([
  P("wui-all-wallets-image")
], Ze);
const Ti = N`
  button {
...
let ye = class extends O {
  ...
  render() {
    const e = this.connectors.find((l) => l.id === "walletConnect"), { allWallets: n } = ee.state;
  ...
  onAllWallets() {
    te.sendEvent({ type: "track", event: "CLICK_ALL_WALLETS" }), U.push("AllWallets");
  }
};
Ae([
  u()
...
Ae([
  _()
], ye.prototype, "connectors", void 0);
Ae([
  _()
], ye.prototype, "count", void 0);
Ae([
  _()
], ye.prototype, "filteredCount", void 0);
Ae([
  _()
], ye.prototype, "isFetchingRecommendedWallets", void 0);
ye = Ae([
...
et = sn([
  P("w3m-connect-announced-widget")
], et);
...
let Ue = class extends O {
  constructor() {
    super(), this.unsubscribe = [], this.tabIdx = void 0, this.connectors = M.state.connectors, this.loading = !1, this.unsubscribe.push(M.subscribeKey("connectors", (e) => this.connectors = e)), j.isTelegram() && j.isIos() && (this.loading = !k.state.wcUri, this.unsubscribe.push(k.subscribeKey("wcUri", (e) => this.loading = !e)));
  }
  disconnectedCallback() {
    this.unsubscribe.forEach((e) => e());
  }
  ...
  filterOutDuplicateWallets(e) {
    const n = ft.getRecentWallets(), i = this.connectors.map((s) => s.info?.rdns).filter(Boolean), o = n.map((s) => s.rdns).filter(Boolean), t = i.concat(o);
...
gt([
  u()
], Ue.prototype, "tabIdx", void 0);
gt([
  _()
], Ue.prototype, "connectors", void 0);
gt([
  _()
], Ue.prototype, "loading", void 0);
Ue = gt([
  P("w3m-connect-custom-widget")
], Ue);
...
let tt = class extends O {
  ...
  render() {
    const i = this.connectors.filter((o) => o.type === "EXTERNAL").filter(Me.showConnector).filter((o) => o.id !== Ci.CONNECTOR_ID.COINBASE_SDK);
    return i?.length ? c`
      <wui-flex flexDirection="column" gap="xs">
        ${i.map((o) => c`
            <wui-list-wallet
...
ln([
  _()
], tt.prototype, "connectors", void 0);
tt = ln([
  P("w3m-connect-external-widget")
], tt);
...
cn([
  u()
], nt.prototype, "wallets", void 0);
nt = cn([
  P("w3m-connect-featured-widget")
], nt);
...
let it = class extends O {
  ...
  render() {
    const e = this.connectors.filter(Me.showConnector);
...
dn([
  u()
], ot.prototype, "tabIdx", void 0);
dn([
  _()
], ot.prototype, "connectors", void 0);
ot = dn([
  P("w3m-connect-multi-chain-widget")
], ot);
...
let qe = class extends O {
  ...
  render() {
    const n = ft.getRecentWallets().filter((i) => !pt.isExcluded(i)).filter((i) => !this.hasWalletConnector(i)).filter((i) => this.isWalletCompatibleWithCurrentChain(i));
    return n.length ? c`
      <wui-flex flexDirection="column" gap="xs">
        ${n.map((i) => c`
            <wui-list-wallet
...
wt([
  u()
], qe.prototype, "tabIdx", void 0);
wt([
  _()
], qe.prototype, "connectors", void 0);
wt([
  _()
], qe.prototype, "loading", void 0);
qe = wt([
  P("w3m-connect-recent-widget")
], qe);
...
let Fe = class extends O {
  constructor() {
    super(), this.unsubscribe = [], this.tabIdx = void 0, this.wallets = [], this.loading = !1, j.isTelegram() && j.isIos() && (this.loading = !k.state.wcUri, this.unsubscribe.push(k.subscribeKey("wcUri", (e) => this.loading = !e)));
  }
  render() {
    const { connectors: e } = M.state, { customWallets: n, featuredWalletIds: i } = ee.state, o = ft.getRecentWallets(), t = e.find((w) => w.id === "walletConnect"), s = e.filter((w) => w.type === "INJECTED" || w.type === "ANNOUNCED" || w.type === "MULTI_CHAIN").filter((w) => w.name !== "Browser Wallet");
    if (!t)
      return null;
    if (i || n || !this.wallets.length)
      return this.style.cssText = "display: none", null;
    const l = s.length + o.length, d = Math.max(0, 2 - l), h = pt.filterOutDuplicateWallets(this.wallets).slice(0, d);
    return h.length ? c`
      <wui-flex flexDirection="column" gap="xs">
        ${h.map((w) => c`
            <wui-list-wallet
...
Fe = mt([
  P("w3m-connect-recommended-widget")
], Fe);
...
let Ve = class extends O {
  ...
  render() {
    ...
    if (!e)
      return this.style.cssText = "display: none", null;
    const n = e.imageUrl || this.connectorImages[e?.imageId ?? ""];
    return c`
      <wui-list-wallet
        imageSrc=${I(n)}
        name=${e.name ?? "Unknown"}
...
bt([
  u()
], Ve.prototype, "tabIdx", void 0);
bt([
  _()
], Ve.prototype, "connectors", void 0);
bt([
  _()
], Ve.prototype, "connectorImages", void 0);
Ve = bt([
  P("w3m-connect-walletconnect-widget")
], Ve);
const Bi = N`
  :host {
...
let xe = class extends O {
  ...
  connectorListTemplate() {
    const { custom: e, recent: n, announced: i, injected: o, multiChain: t, recommended: a, featured: s, external: l } = Me.getConnectorsByType(this.connectors, this.recommended, this.featured);
    return Me.getConnectorTypeOrder({
      custom: e,
      recent: n,
      announced: i,
      injected: o,
...
Ke([
  _()
], xe.prototype, "connectors", void 0);
Ke([
  _()
], xe.prototype, "recommended", void 0);
Ke([
  _()
], xe.prototype, "featured", void 0);
xe = Ke([
...
let re = class extends O {
  ...
  animateTabs(e, n) {
    const i = this.buttons[this.activeTab], o = this.buttons[e], t = i?.querySelector("wui-text"), a = o?.querySelector("wui-text"), s = o?.getBoundingClientRect(), l = a?.getBoundingClientRect();
    i && t && !n && e !== this.activeTab && (t.animate([{ opacity: 0 }], {
      duration: 50,
      easing: "ease",
      fill: "forwards"
      ...
      easing: "ease",
      fill: "forwards"
    })), o && s && l && a && (e !== this.activeTab || n) && (this.localTabWidth = `${Math.round(s.width + l.width) + 6}px`, o.animate([{ width: `${s.width + l.width}px` }], {
      duration: n ? 0 : 500,
      fill: "forwards",
      easing: "ease"
    }), a.animate([{ opacity: 1 }], {
...
ve([
  u({ type: Array })
], re.prototype, "tabs", void 0);
ve([
  u()
], re.prototype, "onTabChange", void 0);
ve([
  u({ type: Array })
], re.prototype, "buttons", void 0);
ve([
  u({ type: Boolean })
], re.prototype, "disabled", void 0);
ve([
  u()
], re.prototype, "localTabWidth", void 0);
ve([
  _()
], re.prototype, "activeTab", void 0);
ve([
  _()
], re.prototype, "isDense", void 0);
re = ve([
  P("wui-tabs")
], re);
...
let rt = class extends O {
  ...
  onTabChange(e) {
    ...
    n && this.onSelectPlatfrom?.(n);
  }
};
hn([
  u({ type: Array })
], rt.prototype, "platforms", void 0);
hn([
  u()
], rt.prototype, "onSelectPlatfrom", void 0);
rt = hn([
...
yt([
  u()
], Pe.prototype, "label", void 0);
yt([
  u()
], Pe.prototype, "buttonLabel", void 0);
Pe = yt([
  P("wui-cta-button")
], Pe);
const Ni = N`
...
let st = class extends O {
  ...
  render() {
    ...
    const { name: e, app_store: n, play_store: i, chrome_store: o, homepage: t } = this.wallet, a = j.isMobile(), s = j.isIos(), l = j.isAndroid(), d = [n, i, t, o].filter(Boolean).length > 1, h = he.getTruncateString({
      string: e,
      charsStart: 12,
      charsEnd: 0,
      truncate: "end"
  ...
  onAppStore() {
    this.wallet?.app_store && j.openHref(this.wallet.app_store, "_blank");
  }
  onPlayStore() {
    this.wallet?.play_store && j.openHref(this.wallet.play_store, "_blank");
  }
  onHomePage() {
    this.wallet?.homepage && j.openHref(this.wallet.homepage, "_blank");
  }
};
st.styles = [Ni];
li([
  u({ type: Object })
], st.prototype, "wallet", void 0);
st = li([
...
class V extends O {
  ...
  onTryAgain() {
    k.setWcError(!1), this.onRetry ? (this.isRetrying = !0, this.onRetry?.()) : this.onConnect?.();
  }
  loaderTemplate() {
  ...
  onCopyUri() {
    try {
      this.uri && (j.copyToClopboard(this.uri), Xe.showSuccess("Link copied"));
    } catch {
      Xe.showError("Failed to copy");
    }
  }
}
V.styles = Mi;
...
se([
  _()
], V.prototype, "showRetry", void 0);
se([
  _()
], V.prototype, "secondaryBtnLabel", void 0);
se([
  _()
], V.prototype, "secondaryLabel", void 0);
se([
  _()
], V.prototype, "isLoading", void 0);
se([
  u({ type: Boolean })
], V.prototype, "isMobile", void 0);
se([
  u()
], V.prototype, "onRetry", void 0);
...
let $n = class extends V {
  constructor() {
    ...
    this.onConnect = this.onConnectProxy.bind(this), this.onAutoConnect = this.onConnectProxy.bind(this), te.sendEvent({
      type: "track",
      event: "SELECT_WALLET",
  ...
  async onConnectProxy() {
    try {
      this.error = !1;
      const { connectors: e } = M.state, n = e.find((i) => i.type === "ANNOUNCED" && i.info?.rdns === this.wallet?.rdns || i.type === "INJECTED" || i.name === this.wallet?.name);
      if (n)
        await k.connectExternal(n, n.chain);
      else
        throw new Error("w3m-connecting-wc-browser: No connector found");
      oi.close(), te.sendEvent({
        type: "track",
...
let Rn = class extends V {
  constructor() {
    ...
    this.onConnect = this.onConnectProxy.bind(this), this.onRender = this.onRenderProxy.bind(this), te.sendEvent({
      type: "track",
      event: "SELECT_WALLET",
...
let Ce = class extends V {
  constructor() {
    if (super(), this.btnLabelTimeout = void 0, this.redirectDeeplink = void 0, this.redirectUniversalLink = void 0, this.target = void 0, this.preferUniversalLinks = ee.state.experimental_preferUniversalLinks, this.isLoading = !0, this.onConnect = () => {
  ...
  onTryAgain() {
    k.setWcError(!1), this.onConnect?.();
  }
};
je([
  _()
], Ce.prototype, "redirectDeeplink", void 0);
je([
  _()
], Ce.prototype, "redirectUniversalLink", void 0);
je([
  _()
], Ce.prototype, "target", void 0);
je([
  _()
], Ce.prototype, "preferUniversalLinks", void 0);
je([
  _()
], Ce.prototype, "isLoading", void 0);
Ce = je([
  P("w3m-connecting-wc-mobile")
], Ce);
var Te = {}, It, _n;
function Fi() {
  return _n || (_n = 1, It = function() {
...
function Ki() {
  ...
  return r.prototype.set = function(e, n, i, o) {
    ...
    this.data[t] = i, o && (this.reservedBit[t] = !0);
  ...
  return Pn || (Pn = 1, function(r) {
    ...
    r.isValid = function(o) {
      ...
      for (let d = 0; d < t; d++) {
        s = l = 0;
        for (let h = 0; h < t; h++)
          s = s << 1 & 2047 | o.get(d, h), h >= 10 && (s === 1488 || s === 93) && a++, l = l << 1 & 2047 | o.get(h, d), h >= 10 && (l === 1488 || l === 93) && a++;
      }
      return a * e.N3;
    ...
    r.applyMask = function(o, t) {
      ...
      for (let s = 0; s < a; s++)
        for (let l = 0; l < a; l++)
          t.isReserved(l, s) || t.xor(l, s, n(o, l, s));
...
function ci() {
  ...
  return Qe.getBlocksCount = function(o, t) {
    switch (t) {
      case r.L:
        return e[(o - 1) * 4 + 0];
      case r.M:
  ...
  }, Qe.getTotalCodewordsCount = function(o, t) {
    switch (t) {
      case r.L:
        return n[(o - 1) * 4 + 0];
      case r.M:
...
function di() {
  ...
  oe.KANJI = new RegExp(n, "g"), oe.BYTE_KANJI = new RegExp("[^A-Z0-9 $%*+\\-./:]+", "g"), oe.BYTE = new RegExp(i, "g"), oe.NUMERIC = new RegExp(r, "g"), oe.ALPHANUMERIC = new RegExp(e, "g");
  const o = new RegExp("^" + n + "$"), t = new RegExp("^" + r + "$"), a = new RegExp("^[A-Z0-9 $%*+\\-./:]+$");
  return oe.testKanji = function(l) {
    return o.test(l);
  }, oe.testNumeric = function(l) {
    return t.test(l);
  }, oe.testAlphanumeric = function(l) {
    return a.test(l);
  }, oe;
}
var zn;
...
function Zi() {
  return Nn || (Nn = 1, function(r) {
    const e = Ie(), n = ci(), i = fn(), o = We(), t = ui(), a = 7973, s = e.getBCHDigit(a);
    function l(x, p, W) {
      for (let v = 1; v <= 40; v++)
        if (p <= r.getCapacity(v, W, x))
          return v;
    }
    function d(x, p) {
    ...
    function w(x, p) {
      for (let W = 1; W <= 40; W++)
        if (h(x, W) <= r.getCapacity(W, p, o.MIXED))
          return W;
    }
    r.from = function(p, W) {
...
function eo() {
  if (Mn) return Nt;
  Mn = 1;
  const r = Ie(), e = 1335, n = 21522, i = r.getBCHDigit(e);
  return Nt.getEncodedBits = function(t, a) {
    const s = t.bit << 3 | a;
    let l = s << 10;
    for (; r.getBCHDigit(l) - i >= 0; )
      l ^= e << r.getBCHDigit(l) - i;
    return (s << 10 | l) ^ n;
  }, Nt;
}
var Mt = {}, Ut, Un;
function to() {
  ...
  return e.getBitsLength = function(i) {
    ...
    for (o = 0; o + 3 <= this.data.length; o += 3)
      t = this.data.substr(o, 3), a = parseInt(t, 10), i.put(a, 10);
...
function oo() {
  ...
  return n.getBitsLength = function(o) {
    ...
    for (let o = 0, t = this.data.length; o < t; o++)
      i.put(this.data[o], 8);
  }, Vt = n, Vt;
}
var Kt, Kn;
...
function ao() {
  return Hn || (Hn = 1, function(r) {
    var e = {
      single_source_shortest_paths: function(n, i, o) {
        var t = {}, a = {};
        a[i] = 0;
        ...
        for (var l, d, h, w, x, p, W, v, S; !s.empty(); ) {
          ...
          for (h in x)
            x.hasOwnProperty(h) && (p = x[h], W = w + p, v = a[h], S = typeof a[h] > "u", (S || v > W) && (a[h] = W, s.push(h, W), t[h] = d));
        }
...
function so() {
  return Gn || (Gn = 1, function(r) {
    const e = We(), n = to(), i = no(), o = oo(), t = ro(), a = di(), s = Ie(), l = ao();
    function d(m) {
    ...
    function w(m) {
      ...
      let f, D;
      return s.isKanjiModeEnabled() ? (f = h(a.BYTE, e.BYTE, m), D = h(a.KANJI, e.KANJI, m)) : (f = h(a.BYTE_KANJI, e.BYTE, m), D = []), g.concat(b, f, D).sort(function(T, E) {
      ...
      for (let b = 0; b < m.length; b++) {
        ...
        switch (f.mode) {
          ...
          case e.KANJI:
            g.push([
              f,
              { data: f.data, mode: e.BYTE, length: d(f.data) }
            ]);
            break;
          case e.BYTE:
            g.push([
    ...
    function v(m, g) {
      ...
      for (let C = 0; C < m.length; C++) {
        ...
        for (let y = 0; y < T.length; y++) {
          const L = T[y], $ = "" + C + y;
          E.push($), b[$] = { node: L, lastCount: 0 }, f[$] = {};
          for (let B = 0; B < D.length; B++) {
            const R = D[B];
            b[R] && b[R].node.mode === L.mode ? (f[R][$] = x(b[R].lastCount + L.length, L.mode) - x(b[R].lastCount, L.mode), b[R].lastCount += L.length) : (b[R] && (b[R].lastCount = L.length), f[R][$] = x(L.length, L.mode) + 4 + e.getCharCountIndicator(L.mode, g));
          }
        }
        D = E;
      }
    ...
    function S(m, g) {
      ...
      if (b = e.from(g, f), b !== e.BYTE && b.bit < f.bit)
        throw new Error('"' + m + '" cannot be encoded with mode ' + e.toString(b) + `.
 Suggested mode is: ` + e.toString(f));
    ...
    r.fromArray = function(g) {
      ...
      const f = w(g, s.isKanjiModeEnabled()), D = W(f), C = v(D, b), T = l.find_path(C.map, "start", "end"), E = [];
      for (let y = 1; y < T.length - 1; y++)
        E.push(C.table[T[y]].node);
      return r.fromArray(p(E));
    }, r.rawSplit = function(g) {
      return r.fromArray(
        w(g, s.isKanjiModeEnabled())
      );
    };
  }(Mt)), Mt;
}
...
function lo() {
  if (Yn) return Wt;
  Yn = 1;
  const r = Ie(), e = fn(), n = Vi(), i = Ki(), o = Hi(), t = Gi(), a = Yi(), s = ci(), l = Xi(), d = Zi(), h = eo(), w = We(), x = so();
  function p(C, T) {
    const E = C.size, y = t.getPositions(T);
    for (let L = 0; L < y.length; L++) {
      const $ = y[L][0], B = y[L][1];
      for (let R = -1; R <= 7; R++)
        if (!($ + R <= -1 || E <= $ + R))
          for (let A = -1; A <= 7; A++)
            B + A <= -1 || E <= B + A || (R >= 0 && R <= 6 && (A === 0 || A === 6) || A >= 0 && A <= 6 && (R === 0 || R === 6) || R >= 2 && R <= 4 && A >= 2 && A <= 4 ? C.set($ + R, B + A, !0, !0) : C.set($ + R, B + A, !1, !0));
    }
  }
  function W(C) {
    const T = C.size;
    for (let E = 8; E < T - 8; E++) {
      const y = E % 2 === 0;
      C.set(E, 6, y, !0), C.set(6, E, y, !0);
    }
  }
  function v(C, T) {
    const E = o.getPositions(T);
    for (let y = 0; y < E.length; y++) {
      const L = E[y][0], $ = E[y][1];
      for (let B = -2; B <= 2; B++)
        for (let R = -2; R <= 2; R++)
          B === -2 || B === 2 || R === -2 || R === 2 || B === 0 && R === 0 ? C.set(L + B, $ + R, !0, !0) : C.set(L + B, $ + R, !1, !0);
    }
  }
  function S(C, T) {
    const E = C.size, y = d.getEncodedBits(T);
    let L, $, B;
    for (let R = 0; R < 18; R++)
      L = Math.floor(R / 3), $ = R % 3 + E - 8 - 3, B = (y >> R & 1) === 1, C.set(L, $, B, !0), C.set($, L, B, !0);
  }
  function m(C, T, E) {
    const y = C.size, L = h.getEncodedBits(T, E);
    let $, B;
    for ($ = 0; $ < 15; $++)
      B = (L >> $ & 1) === 1, $ < 6 ? C.set($, 8, B, !0) : $ < 8 ? C.set($ + 1, 8, B, !0) : C.set(y - 15 + $, 8, B, !0), $ < 8 ? C.set(8, y - $ - 1, B, !0) : $ < 9 ? C.set(8, 15 - $ - 1 + 1, B, !0) : C.set(8, 15 - $ - 1, B, !0);
    C.set(y - 8, 8, 1, !0);
  }
  function g(C, T) {
    const E = C.size;
    ...
    for (let R = E - 1; R > 0; R -= 2)
      for (R === 6 && R--; ; ) {
        for (let A = 0; A < 2; A++)
          if (!C.isReserved(L, R - A)) {
            let we = !1;
            B < T.length && (we = (T[B] >>> $ & 1) === 1), C.set(L, R - A, we), $--, $ === -1 && (B++, $ = 7);
          }
        if (L += y, L < 0 || E <= L) {
          L -= y, y = -y;
          break;
  ...
  function b(C, T, E) {
    ...
    const L = r.getSymbolTotalCodewords(C), $ = s.getTotalCodewordsCount(C, T), B = (L - $) * 8;
    for (y.getLengthInBits() + 4 <= B && y.put(0, 4); y.getLengthInBits() % 8 !== 0; )
      y.putBit(0);
    const R = (B - y.getLengthInBits()) / 8;
    for (let A = 0; A < R; A++)
      y.put(A % 2 ? 17 : 236, 8);
    return f(y, C, T);
  }
  function f(C, T, E) {
    const y = r.getSymbolTotalCodewords(T), L = s.getTotalCodewordsCount(T, E), $ = y - L, B = s.getBlocksCount(T, E), R = y % B, A = B - R, we = Math.floor(y / B), De = Math.floor($ / B), vi = De + 1, mn = we - De, yi = new l(mn);
    let Ct = 0;
    const Je = new Array(B), bn = new Array(B);
    let $t = 0;
    const xi = new Uint8Array(C.buffer);
    for (let Se = 0; Se < B; Se++) {
      const _t = Se < A ? De : vi;
      Je[Se] = xi.slice(Ct, Ct + _t), bn[Se] = yi.encode(Je[Se]), Ct += _t, $t = Math.max($t, _t);
    }
    const Rt = new Uint8Array(y);
    let vn = 0, ce, ue;
    for (ce = 0; ce < $t; ce++)
      for (ue = 0; ue < B; ue++)
        ce < Je[ue].length && (Rt[vn++] = Je[ue][ce]);
    for (ce = 0; ce < mn; ce++)
      for (ue = 0; ue < B; ue++)
        Rt[vn++] = bn[ue][ce];
    return Rt;
  ...
  function D(C, T, E, y) {
    ...
    if (Array.isArray(C))
      ...
      let we = T;
      if (!we) {
        const De = x.rawSplit(C);
        we = d.getBestVersionForData(De, E);
      }
      L = x.fromString(C, we || 40);
    } else
      throw new Error("Invalid data");
    const $ = d.getBestVersionForData(L, E);
    if (!$)
...
`
    ...
    const B = b(T, E, L), R = r.getSymbolSize(T), A = new i(R);
    return p(A, T), W(A), v(A, T), m(A, E, 0), T >= 7 && S(A, T), g(A, B), isNaN(y) && (y = a.getBestMask(
      A,
      m.bind(null, A, E)
    )), a.applyMask(y, A), m(A, E, y), {
      modules: A,
      version: T,
  ...
  return Wt.create = function(T, E) {
    if (typeof T > "u" || T === "")
      throw new Error("No input text");
    let y = e.M, L, $;
    return typeof E < "u" && (y = e.from(E.errorCorrectionLevel, e.M), L = d.from(E.version), $ = a.from(E.maskPattern), E.toSJISFunc && r.setToSJISFunction(E.toSJISFunc)), D(T, L, y, $);
  }, Wt;
}
var Gt = {}, Yt = {}, Jn;
function hi() {
...
function uo() {
  ...
  function i(o, t, a) {
    ...
    for (let w = 0; w < o.length; w++) {
      ...
      !x && !d && (d = !0), o[w] ? (h++, w > 0 && x > 0 && o[w - 1] || (s += d ? n("M", x + a, 0.5 + p + a) : n("m", l, 0), l = 0, d = !1), x + 1 < t && o[w + 1] || (s += n("h", h), h = 0)) : l++;
    }
    return s;
  }
...
var fo = ho();
const po = /* @__PURE__ */ Ii(fo), go = 0.1, ei = 2.5, de = 7;
function Qt(r, e, n) {
  return r === e ? !1 : (r - e < 0 ? e - r : r - e) <= n + go;
}
function wo(r, e) {
...
const mo = {
  generate({ uri: r, size: e, logoSize: n, dotColor: i = "#141414" }) {
    const o = "transparent", a = [], s = wo(r, "Q"), l = e / s.length, d = [
      { x: 0, y: 0 },
      { x: 1, y: 0 },
      { x: 0, y: 1 }
    ];
    d.forEach(({ x: v, y: S }) => {
      const m = (s.length - de) * l * v, g = (s.length - de) * l * S, b = 0.45;
    ...
    s.forEach((v, S) => {
      v.forEach((m, g) => {
        if (s[S][g] && !(S < de && g < de || S > s.length - (de + 1) && g < de || S < de && g > s.length - (de + 1)) && !(S > w && S < x && g > w && g < x)) {
...
He([
  u()
], $e.prototype, "borderRadius", void 0);
He([
  u()
...
let nn = class extends V {
  constructor() {
    super(), this.forceUpdate = () => {
      this.requestUpdate();
    }, window.addEventListener("resize", this.forceUpdate), te.sendEvent({
      type: "track",
      event: "SELECT_WALLET",
...
let ti = class extends O {
  constructor() {
    if (super(), this.wallet = U.state.data?.wallet, !this.wallet)
...
let Le = class extends O {
  constructor() {
    super(), this.wallet = U.state.data?.wallet, this.unsubscribe = [], this.platform = void 0, this.platforms = [], this.isSiwxEnabled = !!ee.state.siwx, this.remoteFeatures = ee.state.remoteFeatures, this.determinePlatforms(), this.initializeConnection(), this.unsubscribe.push(ee.subscribeKey("remoteFeatures", (e) => this.remoteFeatures = e));
  }
  disconnectedCallback() {
    this.unsubscribe.forEach((e) => e());
  }
  ...
  reownBrandingTemplate() {
    return this.remoteFeatures?.reownBranding ? c`<wui-ux-by-reown></wui-ux-by-reown>` : null;
  }
  async initializeConnection(e = !1) {
    if (!(this.platform === "browser" || ee.state.manualWCControl && !e))
      try {
        const { wcPairingExpiry: n, status: i } = k.state;
        (e || ee.state.enableEmbedded || j.isPairingExpired(n) || i === "connecting") && (await k.connectWalletConnect(), this.isSiwxEnabled || oi.close());
      } catch (n) {
        te.sendEvent({
          type: "track",
          event: "CONNECT_ERROR",
          properties: { message: n?.message ?? "Unknown" }
        }), k.setWcError(!0), Xe.showError(n.message ?? "Connection error"), k.resetWcConnection(), U.goBack();
      }
  }
  determinePlatforms() {
    if (!this.wallet) {
    ...
    if (this.platform)
      return;
    const { mobile_link: e, desktop_link: n, webapp_link: i, injected: o, rdns: t } = this.wallet, a = o?.map(({ injected_id: W }) => W).filter(Boolean), s = [...t ? [t] : a ?? []], l = ee.state.isUniversalProvider ? !1 : s.length, d = e, h = i, w = k.checkInstalled(s), x = l && w, p = n && !j.isMobile();
  ...
  async onSelectPlatform(e) {
    const n = this.shadowRoot?.querySelector("div");
...
Ge([
  _()
], Le.prototype, "platform", void 0);
Ge([
  _()
], Le.prototype, "platforms", void 0);
Ge([
  _()
], Le.prototype, "isSiwxEnabled", void 0);
Ge([
  _()
], Le.prototype, "remoteFeatures", void 0);
Le = Ge([
...
let rn = class extends O {
  ...
  render() {
    if (this.isMobile) {
      const { featured: e, recommended: n } = z.state, { customWallets: i } = ee.state, o = ft.getRecentWallets(), t = e.length || n.length || i?.length || o.length;
      return c`<wui-flex
        flexDirection="column"
        gap="xs"
        .margin=${["3xs", "s", "s", "s"]}
...
const Xt = /* @__PURE__ */ new WeakMap(), gn = Ri(class extends _i {
  render(r) {
    return xn;
  }
  update(r, [e]) {
    const n = e !== this.G;
    return n && this.G !== void 0 && this.rt(void 0), (n || this.lt !== this.ct) && (this.G = e, this.ht = r.options?.host, this.rt(this.ct = r.element)), xn;
  }
  rt(r) {
  ...
  get lt() {
    return typeof this.G == "function" ? Xt.get(this.ht ?? globalThis)?.get(this.G) : this.G?.value;
  }
  disconnected() {
...
let X = class extends O {
  constructor() {
    super(...arguments), this.inputElementRef = pn(), this.size = "md", this.disabled = !1, this.placeholder = "", this.type = "text", this.value = "";
  }
  render() {
    const e = `wui-padding-right-${this.inputRightPadding}`, i = {
...
le([
  u()
], X.prototype, "keyHint", void 0);
le([
  u()
], X.prototype, "value", void 0);
le([
  u()
], X.prototype, "inputRightPadding", void 0);
le([
  u()
], X.prototype, "tabIdx", void 0);
X = le([
  P("wui-input-text")
], X);
const Po = N`
...
let an = class extends O {
  ...
  clearValue() {
    const n = this.inputComponentRef.value?.inputElementRef.value;
...
const Oo = Ne`<svg  viewBox="0 0 48 54" fill="none">
  <path
...
Z([
  u()
], H.prototype, "gridTemplateRows", void 0);
Z([
  u()
], H.prototype, "gridTemplateColumns", void 0);
Z([
  u()
], H.prototype, "justifyItems", void 0);
Z([
  u()
], H.prototype, "alignItems", void 0);
Z([
  u()
], H.prototype, "justifyContent", void 0);
Z([
  u()
], H.prototype, "alignContent", void 0);
Z([
  u()
], H.prototype, "columnGap", void 0);
Z([
  u()
], H.prototype, "rowGap", void 0);
Z([
  u()
], H.prototype, "gap", void 0);
Z([
  u()
], H.prototype, "padding", void 0);
Z([
  u()
], H.prototype, "margin", void 0);
H = Z([
  P("wui-grid")
], H);
const ko = N`
...
let Re = class extends O {
  constructor() {
    ...
    }), this.visible = !1, this.imageSrc = void 0, this.imageLoading = !1, this.wallet = void 0, this.observer = new IntersectionObserver((e) => {
      e.forEach((n) => {
        n.isIntersecting ? (this.visible = !0, this.fetchImageSrc()) : this.visible = !1;
      });
    }, { threshold: 0.01 });
  }
  firstUpdated() {
...
Ye([
  _()
], Re.prototype, "visible", void 0);
Ye([
  _()
], Re.prototype, "imageSrc", void 0);
Ye([
  _()
], Re.prototype, "imageLoading", void 0);
Ye([
  u()
], Re.prototype, "wallet", void 0);
Re = Ye([
...
let be = class extends O {
  ...
  async initialFetch() {
    ...
    e && (await z.fetchWalletsByPage({ page: 1 }), await e.animate([{ opacity: 1 }, { opacity: 0 }], {
      duration: 200,
      fill: "forwards",
      easing: "ease"
  ...
  walletsTemplate() {
    const e = this.filteredWallets?.length > 0 ? j.uniqueBy([...this.featured, ...this.recommended, ...this.filteredWallets], "id") : j.uniqueBy([...this.featured, ...this.recommended, ...this.wallets], "id");
    return pt.markWalletsAsInstalled(e).map((i) => c`
  ...
  createPaginationObserver() {
    const e = this.shadowRoot?.querySelector(`#${ni}`);
    e && (this.paginationObserver = new IntersectionObserver(([n]) => {
      if (n?.isIntersecting && !this.loading) {
...
ke([
  _()
], be.prototype, "loading", void 0);
ke([
  _()
], be.prototype, "wallets", void 0);
ke([
  _()
...
ke([
  _()
], be.prototype, "filteredWallets", void 0);
be = ke([
...
let Oe = class extends O {
  ...
  async onSearch() {
    (this.query.trim() !== this.prevQuery.trim() || this.badge !== this.prevBadge) && (this.prevQuery = this.query, this.prevBadge = this.badge, this.loading = !0, await z.searchWallet({ search: this.query, badge: this.badge }), this.loading = !1);
  }
  walletsTemplate() {
    const { search: e } = z.state, n = pt.markWalletsAsInstalled(e);
    return e.length ? c`
      <wui-grid
...
xt([
  _()
], Oe.prototype, "loading", void 0);
xt([
  u()
], Oe.prototype, "query", void 0);
xt([
  u()
], Oe.prototype, "badge", void 0);
Oe = xt([
...
let ht = class extends O {
  ...
  onClick() {
    ...
    this.badge = "certified", Xe.showSvg("Only WalletConnect certified", {
...
wn([
  _()
], ht.prototype, "search", void 0);
wn([
  _()
], ht.prototype, "badge", void 0);
ht = wn([
...
let J = class extends O {
  ...
  visualTemplate() {
    if (this.variant === "image" && this.imageSrc)
      return c`<wui-image src=${this.imageSrc} alt=${this.alt ?? "list item"}></wui-image>`;
    if (this.iconVariant === "square" && this.icon && this.variant === "icon")
      return c`<wui-icon name=${this.icon}></wui-icon>`;
...
ie([
  u()
], J.prototype, "iconVariant", void 0);
ie([
  u({ type: Boolean })
], J.prototype, "disabled", void 0);
ie([
  u()
], J.prototype, "imageSrc", void 0);
ie([
  u()
], J.prototype, "alt", void 0);
ie([
  u({ type: Boolean })
], J.prototype, "chevron", void 0);
ie([
  u({ type: Boolean })
...
let ii = class extends O {
  constructor() {
    super(...arguments), this.wallet = U.state.data?.wallet;
  }
  render() {
    if (!this.wallet)
  ...
  chromeTemplate() {
    return this.wallet?.chrome_store ? c`<wui-list-item
      variant="icon"
      icon="chromeStore"
      iconVariant="square"
  ...
  iosTemplate() {
    return this.wallet?.app_store ? c`<wui-list-item
      variant="icon"
      icon="appStore"
      iconVariant="square"
      @click=${this.onAppStore.bind(this)}
  ...
  androidTemplate() {
    return this.wallet?.play_store ? c`<wui-list-item
      variant="icon"
      icon="playStore"
      iconVariant="square"
      @click=${this.onPlayStore.bind(this)}
  ...
  onChromeStore() {
    this.wallet?.chrome_store && j.openHref(this.wallet.chrome_store, "_blank");
  }
  onAppStore() {
    this.wallet?.app_store && j.openHref(this.wallet.app_store, "_blank");
  }
