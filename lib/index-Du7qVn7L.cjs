...
`;var C=function(t,e,r,i){var s=arguments.length,o=s<3?e:i===null?i=Object.getOwnPropertyDescriptor(e,r):i,n;if(typeof Reflect=="object"&&typeof Reflect.decorate=="function")o=Reflect.decorate(t,e,r,i);else for(var a=t.length-1;a>=0;a--)(n=t[a])&&(o=(s<3?n(o):s>3?n(e,r,o):n(e,r))||o);return s>3&&o&&Object.defineProperty(e,r,o),o};const I={add:async()=>(await Promise.resolve().then(()=>require("./add-D6nWQv4T.cjs"))).addSvg,allWallets:async()=>(await Promise.resolve().then(()=>require("./all-wallets-BbcZsGrh.cjs"))).allWalletsSvg,arrowBottomCircle:async()=>(await Promise.resolve().then(()=>require("./arrow-bottom-circle-yH_K2-pL.cjs"))).arrowBottomCircleSvg,appStore:async()=>(await Promise.resolve().then(()=>require("./app-store-VHpQ9rTg.cjs"))).appStoreSvg,apple:async()=>(await Promise.resolve().then(()=>require("./apple-BS_U9w7Q.cjs"))).appleSvg,arrowBottom:async()=>(await Promise.resolve().then(()=>require("./arrow-bottom-BvzNYtmD.cjs"))).arrowBottomSvg,arrowLeft:async()=>(await Promise.resolve().then(()=>require("./arrow-left-DkZNnV_Z.cjs"))).arrowLeftSvg,arrowRight:async()=>(await Promise.resolve().then(()=>require("./arrow-right-BBhyAAh0.cjs"))).arrowRightSvg,arrowTop:async()=>(await Promise.resolve().then(()=>require("./arrow-top-C4wsR-0t.cjs"))).arrowTopSvg,bank:async()=>(await Promise.resolve().then(()=>require("./bank-N1g-GUrZ.cjs"))).bankSvg,browser:async()=>(await Promise.resolve().then(()=>require("./browser-WFhH_x-K.cjs"))).browserSvg,card:async()=>(await Promise.resolve().then(()=>require("./card-BfqfWZ0J.cjs"))).cardSvg,checkmark:async()=>(await Promise.resolve().then(()=>require("./checkmark-B290L9kj.cjs"))).checkmarkSvg,checkmarkBold:async()=>(await Promise.resolve().then(()=>require("./checkmark-bold-BUc1HXct.cjs"))).checkmarkBoldSvg,chevronBottom:async()=>(await Promise.resolve().then(()=>require("./chevron-bottom-Ba9wJiSb.cjs"))).chevronBottomSvg,chevronLeft:async()=>(await Promise.resolve().then(()=>require("./chevron-left-BolfbV4R.cjs"))).chevronLeftSvg,chevronRight:async()=>(await Promise.resolve().then(()=>require("./chevron-right-CpkF_ETa.cjs"))).chevronRightSvg,chevronTop:async()=>(await Promise.resolve().then(()=>require("./chevron-top-DmU7a7xp.cjs"))).chevronTopSvg,chromeStore:async()=>(await Promise.resolve().then(()=>require("./chrome-store-Du2gyqrf.cjs"))).chromeStoreSvg,clock:async()=>(await Promise.resolve().then(()=>require("./clock-85kSadFX.cjs"))).clockSvg,close:async()=>(await Promise.resolve().then(()=>require("./close-BxVsuFNv.cjs"))).closeSvg,compass:async()=>(await Promise.resolve().then(()=>require("./compass-DwOpo43F.cjs"))).compassSvg,coinPlaceholder:async()=>(await Promise.resolve().then(()=>require("./coinPlaceholder-BNDtr01j.cjs"))).coinPlaceholderSvg,copy:async()=>(await Promise.resolve().then(()=>require("./copy-7ti4RBWa.cjs"))).copySvg,cursor:async()=>(await Promise.resolve().then(()=>require("./cursor-C8nH84_2.cjs"))).cursorSvg,cursorTransparent:async()=>(await Promise.resolve().then(()=>require("./cursor-transparent-D7r2BiTP.cjs"))).cursorTransparentSvg,desktop:async()=>(await Promise.resolve().then(()=>require("./desktop-DA4CJQo_.cjs"))).desktopSvg,disconnect:async()=>(await Promise.resolve().then(()=>require("./disconnect-nJXn8s_j.cjs"))).disconnectSvg,discord:async()=>(await Promise.resolve().then(()=>require("./discord-D3iF_Bk_.cjs"))).discordSvg,etherscan:async()=>(await Promise.resolve().then(()=>require("./etherscan-C2zLgHgb.cjs"))).etherscanSvg,extension:async()=>(await Promise.resolve().then(()=>require("./extension-BuavxjEg.cjs"))).extensionSvg,externalLink:async()=>(await Promise.resolve().then(()=>require("./external-link-khz_uG53.cjs"))).externalLinkSvg,facebook:async()=>(await Promise.resolve().then(()=>require("./facebook-BqX2ec_0.cjs"))).facebookSvg,farcaster:async()=>(await Promise.resolve().then(()=>require("./farcaster-DAEvIc8q.cjs"))).farcasterSvg,filters:async()=>(await Promise.resolve().then(()=>require("./filters-D7XrE0ec.cjs"))).filtersSvg,github:async()=>(await Promise.resolve().then(()=>require("./github-IsbbgnKH.cjs"))).githubSvg,google:async()=>(await Promise.resolve().then(()=>require("./google-5cJ937uK.cjs"))).googleSvg,helpCircle:async()=>(await Promise.resolve().then(()=>require("./help-circle-DZyVwJav.cjs"))).helpCircleSvg,image:async()=>(await Promise.resolve().then(()=>require("./image-DrUNdvos.cjs"))).imageSvg,id:async()=>(await Promise.resolve().then(()=>require("./id-DG1W_Xec.cjs"))).idSvg,infoCircle:async()=>(await Promise.resolve().then(()=>require("./info-circle-Caid1jRK.cjs"))).infoCircleSvg,lightbulb:async()=>(await Promise.resolve().then(()=>require("./lightbulb-BXqc6thX.cjs"))).lightbulbSvg,mail:async()=>(await Promise.resolve().then(()=>require("./mail-Dk0JsRJT.cjs"))).mailSvg,mobile:async()=>(await Promise.resolve().then(()=>require("./mobile-D04VFJbr.cjs"))).mobileSvg,more:async()=>(await Promise.resolve().then(()=>require("./more-DCPiZ9Ue.cjs"))).moreSvg,networkPlaceholder:async()=>(await Promise.resolve().then(()=>require("./network-placeholder-BWcPNBwD.cjs"))).networkPlaceholderSvg,nftPlaceholder:async()=>(await Promise.resolve().then(()=>require("./nftPlaceholder-CXZDtTwd.cjs"))).nftPlaceholderSvg,off:async()=>(await Promise.resolve().then(()=>require("./off-Bc_ttxLX.cjs"))).offSvg,playStore:async()=>(await Promise.resolve().then(()=>require("./play-store-B_Nnk5p4.cjs"))).playStoreSvg,plus:async()=>(await Promise.resolve().then(()=>require("./plus-ClpU2-eN.cjs"))).plusSvg,qrCode:async()=>(await Promise.resolve().then(()=>require("./qr-code-DmQkFrTo.cjs"))).qrCodeIcon,recycleHorizontal:async()=>(await Promise.resolve().then(()=>require("./recycle-horizontal-BuhGa9BG.cjs"))).recycleHorizontalSvg,refresh:async()=>(await Promise.resolve().then(()=>require("./refresh-BtfB-vI1.cjs"))).refreshSvg,search:async()=>(await Promise.resolve().then(()=>require("./search-DaRfj9T3.cjs"))).searchSvg,send:async()=>(await Promise.resolve().then(()=>require("./send-Dm-g8GV0.cjs"))).sendSvg,swapHorizontal:async()=>(await Promise.resolve().then(()=>require("./swapHorizontal-DADoQyPe.cjs"))).swapHorizontalSvg,swapHorizontalMedium:async()=>(await Promise.resolve().then(()=>require("./swapHorizontalMedium-CZo3ZRxD.cjs"))).swapHorizontalMediumSvg,swapHorizontalBold:async()=>(await Promise.resolve().then(()=>require("./swapHorizontalBold-BV-C8tLd.cjs"))).swapHorizontalBoldSvg,swapHorizontalRoundedBold:async()=>(await Promise.resolve().then(()=>require("./swapHorizontalRoundedBold-C17KgkFv.cjs"))).swapHorizontalRoundedBoldSvg,swapVertical:async()=>(await Promise.resolve().then(()=>require("./swapVertical-DpZg1PoB.cjs"))).swapVerticalSvg,telegram:async()=>(await Promise.resolve().then(()=>require("./telegram-D0ND-WIM.cjs"))).telegramSvg,threeDots:async()=>(await Promise.resolve().then(()=>require("./three-dots-DLrYKg2b.cjs"))).threeDotsSvg,twitch:async()=>(await Promise.resolve().then(()=>require("./twitch-iNvQnvV7.cjs"))).twitchSvg,twitter:async()=>(await Promise.resolve().then(()=>require("./x-3V5vP5tO.cjs"))).xSvg,twitterIcon:async()=>(await Promise.resolve().then(()=>require("./twitterIcon-BCzkt0AB.cjs"))).twitterIconSvg,verify:async()=>(await Promise.resolve().then(()=>require("./verify-C9hFwosi.cjs"))).verifySvg,verifyFilled:async()=>(await Promise.resolve().then(()=>require("./verify-filled-Cy7kcEsb.cjs"))).verifyFilledSvg,wallet:async()=>(await Promise.resolve().then(()=>require("./wallet-Do8SMzQZ.cjs"))).walletSvg,walletConnect:async()=>(await Promise.resolve().then(()=>require("./walletconnect-cQbiUGQ4.cjs"))).walletConnectSvg,walletConnectLightBrown:async()=>(await Promise.resolve().then(()=>require("./walletconnect-cQbiUGQ4.cjs"))).walletConnectLightBrownSvg,walletConnectBrown:async()=>(await Promise.resolve().then(()=>require("./walletconnect-cQbiUGQ4.cjs"))).walletConnectBrownSvg,walletPlaceholder:async()=>(await Promise.resolve().then(()=>require("./wallet-placeholder-B9akPEVq.cjs"))).walletPlaceholderSvg,warningCircle:async()=>(await Promise.resolve().then(()=>require("./warning-circle-ZhVfMwq7.cjs"))).warningCircleSvg,x:async()=>(await Promise.resolve().then(()=>require("./x-3V5vP5tO.cjs"))).xSvg,info:async()=>(await Promise.resolve().then(()=>require("./info-DRUPTh7T.cjs"))).infoSvg,exclamationTriangle:async()=>(await Promise.resolve().then(()=>require("./exclamation-triangle-BWBgLBBl.cjs"))).exclamationTriangleSvg,reown:async()=>(await Promise.resolve().then(()=>require("./reown-logo-BMpY2GYy.cjs"))).reownSvg};async function ne(t){if(j.has(t))return j.get(t);const r=(I[t]??I.copy)();return j.set(t,r),r}let y=class extends l.i$1{constructor(){super(...arguments),this.size="md",this.name="copy",this.color="fg-300",this.aspectRatio="1 / 1"}render(){return this.style.cssText=`
