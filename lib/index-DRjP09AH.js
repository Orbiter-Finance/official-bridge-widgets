import { t as N, u as V, i as b, r as $, c as S, x as m, v as q, y as B, d as W, e as Y } from "./core-BNhhrQgi.js";
const w = {
...
const U = {
  add: async () => (await import("./add-CnIH9cw5.js")).addSvg,
  allWallets: async () => (await import("./all-wallets-BZwvFmUo.js")).allWalletsSvg,
  arrowBottomCircle: async () => (await import("./arrow-bottom-circle-D3DwJjb2.js")).arrowBottomCircleSvg,
  appStore: async () => (await import("./app-store-DEEX6_KF.js")).appStoreSvg,
  apple: async () => (await import("./apple-9EaqBEj1.js")).appleSvg,
  arrowBottom: async () => (await import("./arrow-bottom-D0wODUxj.js")).arrowBottomSvg,
  arrowLeft: async () => (await import("./arrow-left-BULPitaS.js")).arrowLeftSvg,
  arrowRight: async () => (await import("./arrow-right-WI_oJ8-9.js")).arrowRightSvg,
  arrowTop: async () => (await import("./arrow-top-Cf6wxsAT.js")).arrowTopSvg,
  bank: async () => (await import("./bank--JBR3Xcx.js")).bankSvg,
  browser: async () => (await import("./browser-C05ikACT.js")).browserSvg,
  card: async () => (await import("./card-CP6lL4R3.js")).cardSvg,
  checkmark: async () => (await import("./checkmark-BTwrqVhm.js")).checkmarkSvg,
  checkmarkBold: async () => (await import("./checkmark-bold-C6cjrITJ.js")).checkmarkBoldSvg,
  chevronBottom: async () => (await import("./chevron-bottom-NPsVM8qy.js")).chevronBottomSvg,
  chevronLeft: async () => (await import("./chevron-left-AuOWYb0l.js")).chevronLeftSvg,
  chevronRight: async () => (await import("./chevron-right-Lmzl-H6n.js")).chevronRightSvg,
  chevronTop: async () => (await import("./chevron-top-Byel4Pfj.js")).chevronTopSvg,
  chromeStore: async () => (await import("./chrome-store-BPHBLv4N.js")).chromeStoreSvg,
  clock: async () => (await import("./clock-6pBZ9l6o.js")).clockSvg,
  close: async () => (await import("./close-DVuHrmPw.js")).closeSvg,
  compass: async () => (await import("./compass-CR_TQ7b8.js")).compassSvg,
  coinPlaceholder: async () => (await import("./coinPlaceholder-Dm8j7RJd.js")).coinPlaceholderSvg,
  copy: async () => (await import("./copy-DcM5vjBp.js")).copySvg,
  cursor: async () => (await import("./cursor-Ds7cjYls.js")).cursorSvg,
  cursorTransparent: async () => (await import("./cursor-transparent-BFgdLKpj.js")).cursorTransparentSvg,
  desktop: async () => (await import("./desktop-6WbYdZ9o.js")).desktopSvg,
  disconnect: async () => (await import("./disconnect-D00FDKKu.js")).disconnectSvg,
  discord: async () => (await import("./discord-DWRPwYVT.js")).discordSvg,
  etherscan: async () => (await import("./etherscan-CSA4g1Xx.js")).etherscanSvg,
  extension: async () => (await import("./extension-CKm5E1DO.js")).extensionSvg,
  externalLink: async () => (await import("./external-link-CyNEUUBT.js")).externalLinkSvg,
  facebook: async () => (await import("./facebook-BwI_C9WL.js")).facebookSvg,
  farcaster: async () => (await import("./farcaster-Bn5LyI6j.js")).farcasterSvg,
  filters: async () => (await import("./filters-5B_GiW9P.js")).filtersSvg,
  github: async () => (await import("./github-DWm7Z-7b.js")).githubSvg,
  google: async () => (await import("./google-B2yXhBu5.js")).googleSvg,
  helpCircle: async () => (await import("./help-circle-Dl8WeCcn.js")).helpCircleSvg,
  image: async () => (await import("./image-37EZc_ns.js")).imageSvg,
  id: async () => (await import("./id-DhiE38VC.js")).idSvg,
  infoCircle: async () => (await import("./info-circle-BWMv5bkQ.js")).infoCircleSvg,
  lightbulb: async () => (await import("./lightbulb-Df9YlqYs.js")).lightbulbSvg,
  mail: async () => (await import("./mail-DO2cmQaw.js")).mailSvg,
  mobile: async () => (await import("./mobile-DXrtuZKr.js")).mobileSvg,
  more: async () => (await import("./more-Ca7PDcij.js")).moreSvg,
  networkPlaceholder: async () => (await import("./network-placeholder-C2Dxh_S2.js")).networkPlaceholderSvg,
  nftPlaceholder: async () => (await import("./nftPlaceholder-I5ig3tom.js")).nftPlaceholderSvg,
  off: async () => (await import("./off-B-sr__Rg.js")).offSvg,
  playStore: async () => (await import("./play-store-CXHr9rLC.js")).playStoreSvg,
  plus: async () => (await import("./plus-Bm5q614i.js")).plusSvg,
  qrCode: async () => (await import("./qr-code-DIKsq6kD.js")).qrCodeIcon,
  recycleHorizontal: async () => (await import("./recycle-horizontal-C4tAS9a5.js")).recycleHorizontalSvg,
  refresh: async () => (await import("./refresh-DrOIyPUc.js")).refreshSvg,
  search: async () => (await import("./search-BWsy8BQn.js")).searchSvg,
  send: async () => (await import("./send-BN0masMM.js")).sendSvg,
  swapHorizontal: async () => (await import("./swapHorizontal-Dr4JprjI.js")).swapHorizontalSvg,
  swapHorizontalMedium: async () => (await import("./swapHorizontalMedium-BmFogmEU.js")).swapHorizontalMediumSvg,
  swapHorizontalBold: async () => (await import("./swapHorizontalBold-Dx2qawun.js")).swapHorizontalBoldSvg,
  swapHorizontalRoundedBold: async () => (await import("./swapHorizontalRoundedBold-O12wbAtV.js")).swapHorizontalRoundedBoldSvg,
  swapVertical: async () => (await import("./swapVertical-BxeeTd7K.js")).swapVerticalSvg,
  telegram: async () => (await import("./telegram-fJTMVehG.js")).telegramSvg,
  threeDots: async () => (await import("./three-dots-B5UKLTdH.js")).threeDotsSvg,
  twitch: async () => (await import("./twitch-CTMEuLWi.js")).twitchSvg,
  twitter: async () => (await import("./x-D7stJ9TL.js")).xSvg,
  twitterIcon: async () => (await import("./twitterIcon-DF5Mbr6M.js")).twitterIconSvg,
  verify: async () => (await import("./verify-kBuqX7g6.js")).verifySvg,
  verifyFilled: async () => (await import("./verify-filled-BSLdkScQ.js")).verifyFilledSvg,
  wallet: async () => (await import("./wallet-Bg568YaX.js")).walletSvg,
  walletConnect: async () => (await import("./walletconnect-BGqYND5T.js")).walletConnectSvg,
  walletConnectLightBrown: async () => (await import("./walletconnect-BGqYND5T.js")).walletConnectLightBrownSvg,
  walletConnectBrown: async () => (await import("./walletconnect-BGqYND5T.js")).walletConnectBrownSvg,
  walletPlaceholder: async () => (await import("./wallet-placeholder-CKmdNbwK.js")).walletPlaceholderSvg,
  warningCircle: async () => (await import("./warning-circle-3Lurfnxt.js")).warningCircleSvg,
  x: async () => (await import("./x-D7stJ9TL.js")).xSvg,
  info: async () => (await import("./info-DBGiKBzn.js")).infoSvg,
  exclamationTriangle: async () => (await import("./exclamation-triangle-C0PtquII.js")).exclamationTriangleSvg,
  reown: async () => (await import("./reown-logo-B1UM-uqr.js")).reownSvg
};
async function pt(e) {
  if (O.has(e))
    return O.get(e);
