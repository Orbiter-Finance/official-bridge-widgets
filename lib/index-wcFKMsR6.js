import { t as N, u as V, i as b, r as $, c as S, x as m, v as q, y as B, d as W, e as Y } from "./core-BqSxo85B.js";
const w = {
...
const U = {
  add: async () => (await import("./add-BZ5uJ08H.js")).addSvg,
  allWallets: async () => (await import("./all-wallets-509msrHL.js")).allWalletsSvg,
  arrowBottomCircle: async () => (await import("./arrow-bottom-circle-3OhgMB_S.js")).arrowBottomCircleSvg,
  appStore: async () => (await import("./app-store-Cto1Kd_e.js")).appStoreSvg,
  apple: async () => (await import("./apple-DWrOptjL.js")).appleSvg,
  arrowBottom: async () => (await import("./arrow-bottom-Bb-Y6uFL.js")).arrowBottomSvg,
  arrowLeft: async () => (await import("./arrow-left-Bezpuw-I.js")).arrowLeftSvg,
  arrowRight: async () => (await import("./arrow-right-BJg4VrbY.js")).arrowRightSvg,
  arrowTop: async () => (await import("./arrow-top-COl_9kDG.js")).arrowTopSvg,
  bank: async () => (await import("./bank-B6OQm5xA.js")).bankSvg,
  browser: async () => (await import("./browser-L7_634VU.js")).browserSvg,
  card: async () => (await import("./card-CZSj2Jfb.js")).cardSvg,
  checkmark: async () => (await import("./checkmark-D6rqw4-X.js")).checkmarkSvg,
  checkmarkBold: async () => (await import("./checkmark-bold-Bpe__HNm.js")).checkmarkBoldSvg,
  chevronBottom: async () => (await import("./chevron-bottom-DZ5JpGZN.js")).chevronBottomSvg,
  chevronLeft: async () => (await import("./chevron-left-DkAZsZ6D.js")).chevronLeftSvg,
  chevronRight: async () => (await import("./chevron-right-BKuSxIqf.js")).chevronRightSvg,
  chevronTop: async () => (await import("./chevron-top-DGgntYdi.js")).chevronTopSvg,
  chromeStore: async () => (await import("./chrome-store-paF1YZXk.js")).chromeStoreSvg,
  clock: async () => (await import("./clock-DmzpRpvh.js")).clockSvg,
  close: async () => (await import("./close-D1a3FKwp.js")).closeSvg,
  compass: async () => (await import("./compass-CspUlaxd.js")).compassSvg,
  coinPlaceholder: async () => (await import("./coinPlaceholder-ClZ1pgC-.js")).coinPlaceholderSvg,
  copy: async () => (await import("./copy-CMP0q_hG.js")).copySvg,
  cursor: async () => (await import("./cursor-rOa9pBI3.js")).cursorSvg,
  cursorTransparent: async () => (await import("./cursor-transparent-BAgcxc4v.js")).cursorTransparentSvg,
  desktop: async () => (await import("./desktop-Bgz0qVV_.js")).desktopSvg,
  disconnect: async () => (await import("./disconnect-DnSJaDUX.js")).disconnectSvg,
  discord: async () => (await import("./discord-BLVHO4VW.js")).discordSvg,
  etherscan: async () => (await import("./etherscan-D7emqWgq.js")).etherscanSvg,
  extension: async () => (await import("./extension-C2cdfTct.js")).extensionSvg,
  externalLink: async () => (await import("./external-link-CrIjRNpg.js")).externalLinkSvg,
  facebook: async () => (await import("./facebook-CFEb6ThN.js")).facebookSvg,
  farcaster: async () => (await import("./farcaster-D3T7g-fX.js")).farcasterSvg,
  filters: async () => (await import("./filters-CnNGdKdZ.js")).filtersSvg,
  github: async () => (await import("./github-DgEikEOP.js")).githubSvg,
  google: async () => (await import("./google-DYX2NeYq.js")).googleSvg,
  helpCircle: async () => (await import("./help-circle-DYMKPBkT.js")).helpCircleSvg,
  image: async () => (await import("./image-uizGch0O.js")).imageSvg,
  id: async () => (await import("./id-ClymIKmY.js")).idSvg,
  infoCircle: async () => (await import("./info-circle-CgVSxvSl.js")).infoCircleSvg,
  lightbulb: async () => (await import("./lightbulb-DNFLlfZy.js")).lightbulbSvg,
  mail: async () => (await import("./mail-DVxPeTAe.js")).mailSvg,
  mobile: async () => (await import("./mobile-BjkZGttx.js")).mobileSvg,
  more: async () => (await import("./more-Qe_rUuif.js")).moreSvg,
  networkPlaceholder: async () => (await import("./network-placeholder-B9EIGS_6.js")).networkPlaceholderSvg,
  nftPlaceholder: async () => (await import("./nftPlaceholder-3za-SUUa.js")).nftPlaceholderSvg,
  off: async () => (await import("./off-qwc2A_EN.js")).offSvg,
  playStore: async () => (await import("./play-store-DzQKhOoW.js")).playStoreSvg,
  plus: async () => (await import("./plus-Bh2By-65.js")).plusSvg,
  qrCode: async () => (await import("./qr-code-GaMrqvTG.js")).qrCodeIcon,
  recycleHorizontal: async () => (await import("./recycle-horizontal-DG8ELlb5.js")).recycleHorizontalSvg,
  refresh: async () => (await import("./refresh-BoxXTQd0.js")).refreshSvg,
  search: async () => (await import("./search-BqP9QNIB.js")).searchSvg,
  send: async () => (await import("./send-Qqn25eU-.js")).sendSvg,
  swapHorizontal: async () => (await import("./swapHorizontal-Cii3GIdy.js")).swapHorizontalSvg,
  swapHorizontalMedium: async () => (await import("./swapHorizontalMedium-BrAl3WwP.js")).swapHorizontalMediumSvg,
  swapHorizontalBold: async () => (await import("./swapHorizontalBold-CWnjP6iR.js")).swapHorizontalBoldSvg,
  swapHorizontalRoundedBold: async () => (await import("./swapHorizontalRoundedBold-BlIWdt5Y.js")).swapHorizontalRoundedBoldSvg,
  swapVertical: async () => (await import("./swapVertical-C94oubRo.js")).swapVerticalSvg,
  telegram: async () => (await import("./telegram-BZSIIj8S.js")).telegramSvg,
  threeDots: async () => (await import("./three-dots-B4GI26EP.js")).threeDotsSvg,
  twitch: async () => (await import("./twitch-DSNThUIi.js")).twitchSvg,
  twitter: async () => (await import("./x-DLl8EEKr.js")).xSvg,
  twitterIcon: async () => (await import("./twitterIcon-GuYQ4jQs.js")).twitterIconSvg,
  verify: async () => (await import("./verify-BnYbUMB8.js")).verifySvg,
  verifyFilled: async () => (await import("./verify-filled-Bpae01FG.js")).verifyFilledSvg,
  wallet: async () => (await import("./wallet-DA4FCOOg.js")).walletSvg,
  walletConnect: async () => (await import("./walletconnect-DRJt2SVz.js")).walletConnectSvg,
  walletConnectLightBrown: async () => (await import("./walletconnect-DRJt2SVz.js")).walletConnectLightBrownSvg,
  walletConnectBrown: async () => (await import("./walletconnect-DRJt2SVz.js")).walletConnectBrownSvg,
  walletPlaceholder: async () => (await import("./wallet-placeholder-BSHnm-kz.js")).walletPlaceholderSvg,
  warningCircle: async () => (await import("./warning-circle-C6J2u8FG.js")).warningCircleSvg,
  x: async () => (await import("./x-DLl8EEKr.js")).xSvg,
  info: async () => (await import("./info-CwaBqxbb.js")).infoSvg,
  exclamationTriangle: async () => (await import("./exclamation-triangle-1zAcwf_8.js")).exclamationTriangleSvg,
  reown: async () => (await import("./reown-logo-Ddd1xUsQ.js")).reownSvg
};
async function pt(e) {
  if (O.has(e))
    return O.get(e);
