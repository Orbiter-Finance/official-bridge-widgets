import { H as Qt, c as It, a as xt, t as Jt, b as de, w as he, r as P, d as ge, e as we, f as pe, g as be } from "./index.es-BHPbW6qX.js";
function ye(n, e, t, r) {
...
class Ee extends Qt {
  constructor(e, t, r, o) {
    super(), this.blockLen = e, this.outputLen = t, this.padOffset = r, this.isLE = o, this.finished = !1, this.length = 0, this.pos = 0, this.destroyed = !1, this.buffer = new Uint8Array(e), this.view = It(this.buffer);
  }
  update(e) {
    xt(this);
  ...
  digestInto(e) {
    xt(this), de(e, this), this.finished = !0;
...
const Et = /* @__PURE__ */ BigInt(0), Bt = /* @__PURE__ */ BigInt(1), Ae = /* @__PURE__ */ BigInt(2);
function it(n) {
...
function Rt(n) {
  return bt(n), Zt(lt(Uint8Array.from(n).reverse()));
}
function ht(n, e) {
...
const Nt = (n) => typeof n == "bigint" && Et <= n;
function vt(n, e, t) {
  return Nt(n) && Nt(e) && Nt(t) && e <= n && n < t;
}
function ot(n, e, t, r) {
  if (!vt(e, t, r))
...
function te(n) {
  let e;
  for (e = 0; n > Et; n >>= Bt, e += 1)
    ;
  return e;
}
function Le(n, e) {
  return n >> BigInt(e) & Bt;
}
function He(n, e, t) {
  return n | (t ? Bt : Et) << BigInt(e);
}
const Vt = (n) => (Ae << BigInt(n - 1)) - Bt, qt = (n) => new Uint8Array(n), Ft = (n) => Uint8Array.from(n);
function ee(n, e, t) {
...
class ne extends Qt {
  ...
  update(e) {
    return xt(this), this.iHash.update(e), this;
  }
  digestInto(e) {
    xt(this), we(e, this.outputLen), this.finished = !0, this.iHash.digestInto(e), this.oHash.update(e), this.oHash.digestInto(e), this.destroy();
  }
  digest() {
...
/*! noble-curves - MIT License (c) 2022 Paul Miller (paulmillr.com) */
const z = BigInt(0), T = BigInt(1), nt = /* @__PURE__ */ BigInt(2), ke = /* @__PURE__ */ BigInt(3), _t = /* @__PURE__ */ BigInt(4), Kt = /* @__PURE__ */ BigInt(5), Pt = /* @__PURE__ */ BigInt(8);
function V(n, e) {
  const t = n % e;
  return t >= z ? t : e + t;
}
...
function Ye(n, e, t = !1) {
  ...
  const c = t ? Rt(n) : rt(n), f = V(c, e - T) + T;
  return t ? Mt(f, o) : ht(f, o);
}
/*! noble-curves - MIT License (c) 2022 Paul Miller (paulmillr.com) */
const Gt = BigInt(0), mt = BigInt(1);
function Ot(n, e) {
  const t = e.negate();
  return n ? t : e;
}
...
const Ht = /* @__PURE__ */ new WeakMap(), ae = /* @__PURE__ */ new WeakMap();
function Ut(n) {
  return ae.get(n) || 1;
}
function Pe(n, e) {
  return {
    ...
    unsafeLadder(t, r, o = n.ZERO) {
      let s = t;
      for (; r > Gt; )
        r & mt && (o = o.add(s)), s = s.double(), r >>= mt;
      return o;
    },
    /**
    ...
    precomputeWindow(t, r) {
      const { windows: o, windowSize: s } = Lt(r, e), c = [];
      let f = t, i = f;
      for (let u = 0; u < o; u++) {
        i = f, c.push(i);
        for (let y = 1; y < s; y++)
     ...
     */
    wNAF(t, r, o) {
      const { windows: s, windowSize: c } = Lt(t, e);
      ...
      for (let l = 0; l < s; l++) {
        ...
        N === 0 ? i = i.add(Ot(g, r[b])) : f = f.add(Ot(x, r[a]));
      }
      return { p: f, f: i };
    },
    /**
    ...
    wNAFUnsafe(t, r, o, s = n.ZERO) {
      const { windows: c, windowSize: f } = Lt(t, e), i = BigInt(2 ** t - 1), u = 2 ** t, y = BigInt(t);
      for (let h = 0; h < c; h++) {
        const l = h * f;
        if (o === Gt)
          break;
        let m = Number(o & i);
        if (o >>= y, m > f && (m -= u, o += mt), m === 0)
          continue;
    ...
    getPrecomputes(t, r, o) {
      let s = Ht.get(r);
      return s || (s = this.precomputeWindow(r, t), t !== 1 && Ht.set(r, o(s))), s;
    },
    wNAFCached(t, r, o) {
      const s = Ut(t);
...
function Qe(n) {
  const e = De(n), { Fp: t } = e, r = ie(e.n, e.nBitLength), o = e.toBytes || ((b, a, g) => {
    const x = a.toAffine();
    return pt(Uint8Array.from([4]), t.toBytes(x.x), t.toBytes(x.y));
  }), s = e.fromBytes || ((b) => {
...
function tn(n) {
  ...
  const { ProjectivePoint: i, normPrivateKeyToScalar: u, weierstrassEquation: y, isWithinCurveOrder: h } = Qe({
    ...e,
    toBytes(d, w, p) {
      const S = w.toAffine(), O = t.toBytes(S.x), _ = pt;
  ...
  class a {
    ...
    recoverPublicKey(w) {
      ...
      const Z = (O & 1) === 0 ? "02" : "03", G = i.fromHex(Z + l(R)), F = f(R), M = c(-_ * F), st = c(S * F), X = i.BASE.multiplyAndAddUnsafe(G, M, st);
      if (!X)
  ...
  function v(d, w, p = C) {
    ...
    function St(tt) {
      ...
      if (!h(ct))
        return;
      const At = f(ct), gt = i.BASE.multiply(ct).toAffine(), et = c(gt.x);
      if (et === W)
        return;
      const wt = c(At * c(X + et * F));
      if (wt === W)
        return;
      let ft = (gt.x === et ? 0 : 2) | Number(gt.y & k), jt = wt;
      return _ && m(wt) && (jt = N(wt), ft ^= 1), new a(et, jt, ft);
    }
    return { seed: st, k2sig: St };
  }
  ...
  function j(d, w, p, S = U) {
    ...
    if (!M || _ && M.hasHighS())
      return !1;
    R && (w = e.hash(w));
    const { r: X, s: St } = M, tt = I(w), ct = f(St), At = c(tt * ct), gt = c(X * ct), et = i.BASE.multiplyAndAddUnsafe(st, At, gt)?.toAffine();
...
/*! noble-curves - MIT License (c) 2022 Paul Miller (paulmillr.com) */
const le = BigInt("0xfffffffffffffffffffffffffffffffffffffffffffffffffffffffefffffc2f"), Wt = BigInt("0xfffffffffffffffffffffffffffffffebaaedce6af48a03bbfd25e8cd0364141"), rn = BigInt(1), zt = BigInt(2), Xt = (n, e) => (n + e / zt) / e;
function on(n) {
  const e = le, t = BigInt(3), r = BigInt(6), o = BigInt(11), s = BigInt(22), c = BigInt(23), f = BigInt(44), i = BigInt(88), u = n * n * n % e, y = u * u * n % e, h = Y(y, t, e) * y % e, l = Y(h, t, e) * y % e, m = Y(l, zt, e) * u % e, N = Y(m, o, e) * m % e, b = Y(N, s, e) * N % e, a = Y(b, f, e) * b % e, g = Y(a, i, e) * a % e, x = Y(g, f, e) * b % e, E = Y(x, t, e) * y % e, q = Y(E, c, e) * N % e, L = Y(q, r, e) * u % e, I = Y(L, zt, e);
  if (!Ct.eql(Ct.sqr(I), n))
    throw new Error("Cannot find square root");
  return I;
}
const Ct = ie(le, void 0, void 0, { sqrt: on }), sn = nn({
  a: BigInt(0),
  // equation params: a, b
  b: BigInt(7),
  Fp: Ct,
