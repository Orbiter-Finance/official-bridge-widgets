import { t as N, u as V, i as b, r as $, c as S, x as m, v as q, y as B, d as W, e as Y } from "./core-eU_dO87C.js";
const w = {
...
const U = {
  add: async () => (await import("./add-DYG2pi-E.js")).addSvg,
  allWallets: async () => (await import("./all-wallets-CNdVBoPF.js")).allWalletsSvg,
  arrowBottomCircle: async () => (await import("./arrow-bottom-circle-D_xwDeL3.js")).arrowBottomCircleSvg,
  appStore: async () => (await import("./app-store-R5UOQolk.js")).appStoreSvg,
  apple: async () => (await import("./apple-D55RQeMK.js")).appleSvg,
  arrowBottom: async () => (await import("./arrow-bottom-Dy7W06KR.js")).arrowBottomSvg,
  arrowLeft: async () => (await import("./arrow-left-Bm0XDPi2.js")).arrowLeftSvg,
  arrowRight: async () => (await import("./arrow-right-DvBQBjf9.js")).arrowRightSvg,
  arrowTop: async () => (await import("./arrow-top-C1ZRjS5N.js")).arrowTopSvg,
  bank: async () => (await import("./bank-C4rdEn8l.js")).bankSvg,
  browser: async () => (await import("./browser-BUL9MPmM.js")).browserSvg,
  card: async () => (await import("./card-Gxz51niR.js")).cardSvg,
  checkmark: async () => (await import("./checkmark-ZL5R_spW.js")).checkmarkSvg,
  checkmarkBold: async () => (await import("./checkmark-bold-DXsPoZys.js")).checkmarkBoldSvg,
  chevronBottom: async () => (await import("./chevron-bottom-Dr_5uSit.js")).chevronBottomSvg,
  chevronLeft: async () => (await import("./chevron-left-Bw9r_03a.js")).chevronLeftSvg,
  chevronRight: async () => (await import("./chevron-right-ChbnBkZR.js")).chevronRightSvg,
  chevronTop: async () => (await import("./chevron-top-Dn7PCPGj.js")).chevronTopSvg,
  chromeStore: async () => (await import("./chrome-store-DyCsPaKi.js")).chromeStoreSvg,
  clock: async () => (await import("./clock-CkqEE0ea.js")).clockSvg,
  close: async () => (await import("./close-DAIQNbo6.js")).closeSvg,
  compass: async () => (await import("./compass-CcWX6Nk9.js")).compassSvg,
  coinPlaceholder: async () => (await import("./coinPlaceholder-CRdbRjMU.js")).coinPlaceholderSvg,
  copy: async () => (await import("./copy-Bz1wqmsX.js")).copySvg,
  cursor: async () => (await import("./cursor-Br2xEkNX.js")).cursorSvg,
  cursorTransparent: async () => (await import("./cursor-transparent-D31pD_VT.js")).cursorTransparentSvg,
  desktop: async () => (await import("./desktop-CuXN0urO.js")).desktopSvg,
  disconnect: async () => (await import("./disconnect-CXiNjJeb.js")).disconnectSvg,
  discord: async () => (await import("./discord-BWdN6cGA.js")).discordSvg,
  etherscan: async () => (await import("./etherscan-DC05DxkJ.js")).etherscanSvg,
  extension: async () => (await import("./extension-KH073Eq4.js")).extensionSvg,
  externalLink: async () => (await import("./external-link-wTIkZQye.js")).externalLinkSvg,
  facebook: async () => (await import("./facebook-DJMXOOK5.js")).facebookSvg,
  farcaster: async () => (await import("./farcaster-LhwWh83t.js")).farcasterSvg,
  filters: async () => (await import("./filters-DJrkSPc2.js")).filtersSvg,
  github: async () => (await import("./github-yzqFOb05.js")).githubSvg,
  google: async () => (await import("./google-DmEV48gs.js")).googleSvg,
  helpCircle: async () => (await import("./help-circle-Du-x8fUD.js")).helpCircleSvg,
  image: async () => (await import("./image-DZgQV6wz.js")).imageSvg,
  id: async () => (await import("./id-DS3d_agx.js")).idSvg,
  infoCircle: async () => (await import("./info-circle-BZOlBiH1.js")).infoCircleSvg,
  lightbulb: async () => (await import("./lightbulb-KLyJmy0o.js")).lightbulbSvg,
  mail: async () => (await import("./mail-BwaHupDy.js")).mailSvg,
  mobile: async () => (await import("./mobile-ChbrFhWk.js")).mobileSvg,
  more: async () => (await import("./more-afQ7TkGZ.js")).moreSvg,
  networkPlaceholder: async () => (await import("./network-placeholder-Dh-5F-w7.js")).networkPlaceholderSvg,
  nftPlaceholder: async () => (await import("./nftPlaceholder-Cru62L_3.js")).nftPlaceholderSvg,
  off: async () => (await import("./off-BWQaetbx.js")).offSvg,
  playStore: async () => (await import("./play-store-Bk7wruMj.js")).playStoreSvg,
  plus: async () => (await import("./plus-OuPuRno4.js")).plusSvg,
  qrCode: async () => (await import("./qr-code-DJOLFQay.js")).qrCodeIcon,
  recycleHorizontal: async () => (await import("./recycle-horizontal-wWjTyU8_.js")).recycleHorizontalSvg,
  refresh: async () => (await import("./refresh-CgUOHCBg.js")).refreshSvg,
  search: async () => (await import("./search-B2on8G_T.js")).searchSvg,
  send: async () => (await import("./send-dXFme4G5.js")).sendSvg,
  swapHorizontal: async () => (await import("./swapHorizontal-COdQ4TFj.js")).swapHorizontalSvg,
  swapHorizontalMedium: async () => (await import("./swapHorizontalMedium-BWz6PPqs.js")).swapHorizontalMediumSvg,
  swapHorizontalBold: async () => (await import("./swapHorizontalBold-EovSibPZ.js")).swapHorizontalBoldSvg,
  swapHorizontalRoundedBold: async () => (await import("./swapHorizontalRoundedBold-Do1iiQ-i.js")).swapHorizontalRoundedBoldSvg,
  swapVertical: async () => (await import("./swapVertical-BBNkwJWh.js")).swapVerticalSvg,
  telegram: async () => (await import("./telegram-ClcxRKSX.js")).telegramSvg,
  threeDots: async () => (await import("./three-dots-Cnsm679j.js")).threeDotsSvg,
  twitch: async () => (await import("./twitch-BkSMARdP.js")).twitchSvg,
  twitter: async () => (await import("./x-DJhlUKkk.js")).xSvg,
  twitterIcon: async () => (await import("./twitterIcon-BjyUJUJF.js")).twitterIconSvg,
  verify: async () => (await import("./verify-B9WzFXqo.js")).verifySvg,
  verifyFilled: async () => (await import("./verify-filled-CjPVneJX.js")).verifyFilledSvg,
  wallet: async () => (await import("./wallet-7hy-a7Oj.js")).walletSvg,
  walletConnect: async () => (await import("./walletconnect-CsKXVKm7.js")).walletConnectSvg,
  walletConnectLightBrown: async () => (await import("./walletconnect-CsKXVKm7.js")).walletConnectLightBrownSvg,
  walletConnectBrown: async () => (await import("./walletconnect-CsKXVKm7.js")).walletConnectBrownSvg,
  walletPlaceholder: async () => (await import("./wallet-placeholder-CmbCt61H.js")).walletPlaceholderSvg,
  warningCircle: async () => (await import("./warning-circle-Co8o3uJ3.js")).warningCircleSvg,
  x: async () => (await import("./x-DJhlUKkk.js")).xSvg,
  info: async () => (await import("./info-BeTnsACm.js")).infoSvg,
  exclamationTriangle: async () => (await import("./exclamation-triangle-BH6GCLdp.js")).exclamationTriangleSvg,
  reown: async () => (await import("./reown-logo-2h9xCslY.js")).reownSvg
};
async function pt(e) {
  if (O.has(e))
    return O.get(e);
