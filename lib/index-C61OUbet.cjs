...
`;var C=function(t,e,r,i){var s=arguments.length,o=s<3?e:i===null?i=Object.getOwnPropertyDescriptor(e,r):i,n;if(typeof Reflect=="object"&&typeof Reflect.decorate=="function")o=Reflect.decorate(t,e,r,i);else for(var a=t.length-1;a>=0;a--)(n=t[a])&&(o=(s<3?n(o):s>3?n(e,r,o):n(e,r))||o);return s>3&&o&&Object.defineProperty(e,r,o),o};const I={add:async()=>(await Promise.resolve().then(()=>require("./add-B4opV-yx.cjs"))).addSvg,allWallets:async()=>(await Promise.resolve().then(()=>require("./all-wallets-CEIxhfTl.cjs"))).allWalletsSvg,arrowBottomCircle:async()=>(await Promise.resolve().then(()=>require("./arrow-bottom-circle-adceAr4g.cjs"))).arrowBottomCircleSvg,appStore:async()=>(await Promise.resolve().then(()=>require("./app-store-BImhkY-V.cjs"))).appStoreSvg,apple:async()=>(await Promise.resolve().then(()=>require("./apple-DFeKclu3.cjs"))).appleSvg,arrowBottom:async()=>(await Promise.resolve().then(()=>require("./arrow-bottom-DUmOjzxr.cjs"))).arrowBottomSvg,arrowLeft:async()=>(await Promise.resolve().then(()=>require("./arrow-left-rse8jRQO.cjs"))).arrowLeftSvg,arrowRight:async()=>(await Promise.resolve().then(()=>require("./arrow-right-ZOrZB_y4.cjs"))).arrowRightSvg,arrowTop:async()=>(await Promise.resolve().then(()=>require("./arrow-top-BxV0bNn0.cjs"))).arrowTopSvg,bank:async()=>(await Promise.resolve().then(()=>require("./bank-Cpo8x7Bx.cjs"))).bankSvg,browser:async()=>(await Promise.resolve().then(()=>require("./browser-BMxysoLs.cjs"))).browserSvg,card:async()=>(await Promise.resolve().then(()=>require("./card-DcQD3lPc.cjs"))).cardSvg,checkmark:async()=>(await Promise.resolve().then(()=>require("./checkmark-BTZjNE08.cjs"))).checkmarkSvg,checkmarkBold:async()=>(await Promise.resolve().then(()=>require("./checkmark-bold-DMjBE4C0.cjs"))).checkmarkBoldSvg,chevronBottom:async()=>(await Promise.resolve().then(()=>require("./chevron-bottom-DHuZqTlU.cjs"))).chevronBottomSvg,chevronLeft:async()=>(await Promise.resolve().then(()=>require("./chevron-left-BDfsB-pT.cjs"))).chevronLeftSvg,chevronRight:async()=>(await Promise.resolve().then(()=>require("./chevron-right-etprPgfI.cjs"))).chevronRightSvg,chevronTop:async()=>(await Promise.resolve().then(()=>require("./chevron-top-BX2aDGvb.cjs"))).chevronTopSvg,chromeStore:async()=>(await Promise.resolve().then(()=>require("./chrome-store-BMpus-D3.cjs"))).chromeStoreSvg,clock:async()=>(await Promise.resolve().then(()=>require("./clock-CKOCwHGS.cjs"))).clockSvg,close:async()=>(await Promise.resolve().then(()=>require("./close-Cvg67k4g.cjs"))).closeSvg,compass:async()=>(await Promise.resolve().then(()=>require("./compass-CJ5_Eqfu.cjs"))).compassSvg,coinPlaceholder:async()=>(await Promise.resolve().then(()=>require("./coinPlaceholder-C1iPPWsu.cjs"))).coinPlaceholderSvg,copy:async()=>(await Promise.resolve().then(()=>require("./copy-DoVnilwv.cjs"))).copySvg,cursor:async()=>(await Promise.resolve().then(()=>require("./cursor-C8O-A348.cjs"))).cursorSvg,cursorTransparent:async()=>(await Promise.resolve().then(()=>require("./cursor-transparent-CamV0LGB.cjs"))).cursorTransparentSvg,desktop:async()=>(await Promise.resolve().then(()=>require("./desktop-D4SL4oWK.cjs"))).desktopSvg,disconnect:async()=>(await Promise.resolve().then(()=>require("./disconnect-Dt2qbp0C.cjs"))).disconnectSvg,discord:async()=>(await Promise.resolve().then(()=>require("./discord-DdmC6cJb.cjs"))).discordSvg,etherscan:async()=>(await Promise.resolve().then(()=>require("./etherscan-CRJCJgTy.cjs"))).etherscanSvg,extension:async()=>(await Promise.resolve().then(()=>require("./extension-BAxFCHcb.cjs"))).extensionSvg,externalLink:async()=>(await Promise.resolve().then(()=>require("./external-link-N-KBBOeM.cjs"))).externalLinkSvg,facebook:async()=>(await Promise.resolve().then(()=>require("./facebook-B5a-N4Xf.cjs"))).facebookSvg,farcaster:async()=>(await Promise.resolve().then(()=>require("./farcaster-BSmd0UIx.cjs"))).farcasterSvg,filters:async()=>(await Promise.resolve().then(()=>require("./filters-DhnVMbDd.cjs"))).filtersSvg,github:async()=>(await Promise.resolve().then(()=>require("./github-DnDHFlJS.cjs"))).githubSvg,google:async()=>(await Promise.resolve().then(()=>require("./google-tltD32Pf.cjs"))).googleSvg,helpCircle:async()=>(await Promise.resolve().then(()=>require("./help-circle-5RtdKFAI.cjs"))).helpCircleSvg,image:async()=>(await Promise.resolve().then(()=>require("./image-zntczYyc.cjs"))).imageSvg,id:async()=>(await Promise.resolve().then(()=>require("./id-B7J81b4F.cjs"))).idSvg,infoCircle:async()=>(await Promise.resolve().then(()=>require("./info-circle-DUtLzJ8z.cjs"))).infoCircleSvg,lightbulb:async()=>(await Promise.resolve().then(()=>require("./lightbulb-D6POMZ1X.cjs"))).lightbulbSvg,mail:async()=>(await Promise.resolve().then(()=>require("./mail-CsFW-uaS.cjs"))).mailSvg,mobile:async()=>(await Promise.resolve().then(()=>require("./mobile-ZaUlJ1VH.cjs"))).mobileSvg,more:async()=>(await Promise.resolve().then(()=>require("./more-C4_C2Gon.cjs"))).moreSvg,networkPlaceholder:async()=>(await Promise.resolve().then(()=>require("./network-placeholder-CyQ8UcQb.cjs"))).networkPlaceholderSvg,nftPlaceholder:async()=>(await Promise.resolve().then(()=>require("./nftPlaceholder-DE2U_msP.cjs"))).nftPlaceholderSvg,off:async()=>(await Promise.resolve().then(()=>require("./off-BkhE26SX.cjs"))).offSvg,playStore:async()=>(await Promise.resolve().then(()=>require("./play-store-DdnyrfmZ.cjs"))).playStoreSvg,plus:async()=>(await Promise.resolve().then(()=>require("./plus-A2_bYU1r.cjs"))).plusSvg,qrCode:async()=>(await Promise.resolve().then(()=>require("./qr-code-BowWXdHR.cjs"))).qrCodeIcon,recycleHorizontal:async()=>(await Promise.resolve().then(()=>require("./recycle-horizontal-D-18jpvQ.cjs"))).recycleHorizontalSvg,refresh:async()=>(await Promise.resolve().then(()=>require("./refresh-DOyYI2Kz.cjs"))).refreshSvg,search:async()=>(await Promise.resolve().then(()=>require("./search-D_9K734t.cjs"))).searchSvg,send:async()=>(await Promise.resolve().then(()=>require("./send-D3I9zGne.cjs"))).sendSvg,swapHorizontal:async()=>(await Promise.resolve().then(()=>require("./swapHorizontal-DcOWjoiu.cjs"))).swapHorizontalSvg,swapHorizontalMedium:async()=>(await Promise.resolve().then(()=>require("./swapHorizontalMedium-DKNfMxz5.cjs"))).swapHorizontalMediumSvg,swapHorizontalBold:async()=>(await Promise.resolve().then(()=>require("./swapHorizontalBold-DMskF4K-.cjs"))).swapHorizontalBoldSvg,swapHorizontalRoundedBold:async()=>(await Promise.resolve().then(()=>require("./swapHorizontalRoundedBold-CjXWH9yB.cjs"))).swapHorizontalRoundedBoldSvg,swapVertical:async()=>(await Promise.resolve().then(()=>require("./swapVertical-tzQGmIYM.cjs"))).swapVerticalSvg,telegram:async()=>(await Promise.resolve().then(()=>require("./telegram-DMgsOoVW.cjs"))).telegramSvg,threeDots:async()=>(await Promise.resolve().then(()=>require("./three-dots-Ct1HQLv9.cjs"))).threeDotsSvg,twitch:async()=>(await Promise.resolve().then(()=>require("./twitch-ClnHUa7t.cjs"))).twitchSvg,twitter:async()=>(await Promise.resolve().then(()=>require("./x-BsH_Uq__.cjs"))).xSvg,twitterIcon:async()=>(await Promise.resolve().then(()=>require("./twitterIcon-BgSDrsv-.cjs"))).twitterIconSvg,verify:async()=>(await Promise.resolve().then(()=>require("./verify-CY69gciq.cjs"))).verifySvg,verifyFilled:async()=>(await Promise.resolve().then(()=>require("./verify-filled-fm5sl_Qp.cjs"))).verifyFilledSvg,wallet:async()=>(await Promise.resolve().then(()=>require("./wallet-DdbxOMw8.cjs"))).walletSvg,walletConnect:async()=>(await Promise.resolve().then(()=>require("./walletconnect-C10t8Hnh.cjs"))).walletConnectSvg,walletConnectLightBrown:async()=>(await Promise.resolve().then(()=>require("./walletconnect-C10t8Hnh.cjs"))).walletConnectLightBrownSvg,walletConnectBrown:async()=>(await Promise.resolve().then(()=>require("./walletconnect-C10t8Hnh.cjs"))).walletConnectBrownSvg,walletPlaceholder:async()=>(await Promise.resolve().then(()=>require("./wallet-placeholder-v8k-_vGr.cjs"))).walletPlaceholderSvg,warningCircle:async()=>(await Promise.resolve().then(()=>require("./warning-circle-CnQV-Jt5.cjs"))).warningCircleSvg,x:async()=>(await Promise.resolve().then(()=>require("./x-BsH_Uq__.cjs"))).xSvg,info:async()=>(await Promise.resolve().then(()=>require("./info-Cnx5uV7E.cjs"))).infoSvg,exclamationTriangle:async()=>(await Promise.resolve().then(()=>require("./exclamation-triangle-BTn-lHZF.cjs"))).exclamationTriangleSvg,reown:async()=>(await Promise.resolve().then(()=>require("./reown-logo-a85SiivD.cjs"))).reownSvg};async function ne(t){if(j.has(t))return j.get(t);const r=(I[t]??I.copy)();return j.set(t,r),r}let y=class extends l.i$1{constructor(){super(...arguments),this.size="md",this.name="copy",this.color="fg-300",this.aspectRatio="1 / 1"}render(){return this.style.cssText=`
