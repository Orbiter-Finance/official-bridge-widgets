...
class Wu extends EE {
  ...
  async injectModalUi() {
    if (!al && X.isClient()) {
      if (await import("./basic-CiI5O6wI.js"), await import("./w3m-modal-CTLcqoMs.js"), !document.querySelector("w3m-modal")) {
