import { t as N, u as V, i as b, r as $, c as S, x as m, v as q, y as B, d as W, e as Y } from "./core-GDJJvib3.js";
const w = {
...
const U = {
  add: async () => (await import("./add-BU_LD9qI.js")).addSvg,
  allWallets: async () => (await import("./all-wallets-CtTOhjaa.js")).allWalletsSvg,
  arrowBottomCircle: async () => (await import("./arrow-bottom-circle-xMbMrswF.js")).arrowBottomCircleSvg,
  appStore: async () => (await import("./app-store-BXvOj9M4.js")).appStoreSvg,
  apple: async () => (await import("./apple-CiAMK50_.js")).appleSvg,
  arrowBottom: async () => (await import("./arrow-bottom-wxg8oiiZ.js")).arrowBottomSvg,
  arrowLeft: async () => (await import("./arrow-left-BcHRZCuH.js")).arrowLeftSvg,
  arrowRight: async () => (await import("./arrow-right-Dr0k-PH7.js")).arrowRightSvg,
  arrowTop: async () => (await import("./arrow-top-C0c12Pu0.js")).arrowTopSvg,
  bank: async () => (await import("./bank-DonabnV3.js")).bankSvg,
  browser: async () => (await import("./browser-CutF63bX.js")).browserSvg,
  card: async () => (await import("./card-tq-46y_r.js")).cardSvg,
  checkmark: async () => (await import("./checkmark-7XIE9vZT.js")).checkmarkSvg,
  checkmarkBold: async () => (await import("./checkmark-bold-BKQtMfMJ.js")).checkmarkBoldSvg,
  chevronBottom: async () => (await import("./chevron-bottom-_usKQ7-h.js")).chevronBottomSvg,
  chevronLeft: async () => (await import("./chevron-left-InSVJPTF.js")).chevronLeftSvg,
  chevronRight: async () => (await import("./chevron-right-DSpAL4i5.js")).chevronRightSvg,
  chevronTop: async () => (await import("./chevron-top-CGohxOV-.js")).chevronTopSvg,
  chromeStore: async () => (await import("./chrome-store-DxYBKzm9.js")).chromeStoreSvg,
  clock: async () => (await import("./clock-DbwoaddZ.js")).clockSvg,
  close: async () => (await import("./close-BFrIGGWG.js")).closeSvg,
  compass: async () => (await import("./compass-BVt0WO1o.js")).compassSvg,
  coinPlaceholder: async () => (await import("./coinPlaceholder-BdwI8dLq.js")).coinPlaceholderSvg,
  copy: async () => (await import("./copy--cNyA-dI.js")).copySvg,
  cursor: async () => (await import("./cursor-suwn4yR-.js")).cursorSvg,
  cursorTransparent: async () => (await import("./cursor-transparent-tZNL96Yd.js")).cursorTransparentSvg,
  desktop: async () => (await import("./desktop-jyEdMWGj.js")).desktopSvg,
  disconnect: async () => (await import("./disconnect-CEpHUhgi.js")).disconnectSvg,
  discord: async () => (await import("./discord-BttMd-9G.js")).discordSvg,
  etherscan: async () => (await import("./etherscan-Bp_7gm3e.js")).etherscanSvg,
  extension: async () => (await import("./extension-B9T0JiW1.js")).extensionSvg,
  externalLink: async () => (await import("./external-link-B-4Gjvhq.js")).externalLinkSvg,
  facebook: async () => (await import("./facebook-D7iX0XEJ.js")).facebookSvg,
  farcaster: async () => (await import("./farcaster-CrWtphfT.js")).farcasterSvg,
  filters: async () => (await import("./filters-D0jRvQb5.js")).filtersSvg,
  github: async () => (await import("./github-CvBSKBXL.js")).githubSvg,
  google: async () => (await import("./google-BHyw4Xnb.js")).googleSvg,
  helpCircle: async () => (await import("./help-circle-BEXcyDwW.js")).helpCircleSvg,
  image: async () => (await import("./image-lHACcOG_.js")).imageSvg,
  id: async () => (await import("./id-CQ07QZ83.js")).idSvg,
  infoCircle: async () => (await import("./info-circle-DW3sviwu.js")).infoCircleSvg,
  lightbulb: async () => (await import("./lightbulb-C85wv8Fl.js")).lightbulbSvg,
  mail: async () => (await import("./mail-D8FznkE3.js")).mailSvg,
  mobile: async () => (await import("./mobile-D8rBfg-P.js")).mobileSvg,
  more: async () => (await import("./more-DrYcadHN.js")).moreSvg,
  networkPlaceholder: async () => (await import("./network-placeholder-DIwRRpdy.js")).networkPlaceholderSvg,
  nftPlaceholder: async () => (await import("./nftPlaceholder-D665yKUY.js")).nftPlaceholderSvg,
  off: async () => (await import("./off-DYuI98nc.js")).offSvg,
  playStore: async () => (await import("./play-store-7JMfj1Y6.js")).playStoreSvg,
  plus: async () => (await import("./plus-B0r_JErk.js")).plusSvg,
  qrCode: async () => (await import("./qr-code-qRLbBIUQ.js")).qrCodeIcon,
  recycleHorizontal: async () => (await import("./recycle-horizontal-Be4gTuHL.js")).recycleHorizontalSvg,
  refresh: async () => (await import("./refresh-CPEbKnkt.js")).refreshSvg,
  search: async () => (await import("./search-DC_tDDab.js")).searchSvg,
  send: async () => (await import("./send-DDP7EP-J.js")).sendSvg,
  swapHorizontal: async () => (await import("./swapHorizontal-DgnXhN73.js")).swapHorizontalSvg,
  swapHorizontalMedium: async () => (await import("./swapHorizontalMedium-QQ-XNQgS.js")).swapHorizontalMediumSvg,
  swapHorizontalBold: async () => (await import("./swapHorizontalBold-J3PqThhj.js")).swapHorizontalBoldSvg,
  swapHorizontalRoundedBold: async () => (await import("./swapHorizontalRoundedBold-DtXKZ3Ll.js")).swapHorizontalRoundedBoldSvg,
  swapVertical: async () => (await import("./swapVertical-CvUTKnaj.js")).swapVerticalSvg,
  telegram: async () => (await import("./telegram-C81VSuPx.js")).telegramSvg,
  threeDots: async () => (await import("./three-dots-DyeDAOds.js")).threeDotsSvg,
  twitch: async () => (await import("./twitch-C1vSyUyp.js")).twitchSvg,
  twitter: async () => (await import("./x-CGypbpIc.js")).xSvg,
  twitterIcon: async () => (await import("./twitterIcon-BSkdFKMe.js")).twitterIconSvg,
  verify: async () => (await import("./verify-mWw0ve-y.js")).verifySvg,
  verifyFilled: async () => (await import("./verify-filled-dQA1maj5.js")).verifyFilledSvg,
  wallet: async () => (await import("./wallet-DC_yhoMz.js")).walletSvg,
  walletConnect: async () => (await import("./walletconnect-D83DQhiU.js")).walletConnectSvg,
  walletConnectLightBrown: async () => (await import("./walletconnect-D83DQhiU.js")).walletConnectLightBrownSvg,
  walletConnectBrown: async () => (await import("./walletconnect-D83DQhiU.js")).walletConnectBrownSvg,
  walletPlaceholder: async () => (await import("./wallet-placeholder-CIBp4Fya.js")).walletPlaceholderSvg,
  warningCircle: async () => (await import("./warning-circle-D5Um-b_T.js")).warningCircleSvg,
  x: async () => (await import("./x-CGypbpIc.js")).xSvg,
  info: async () => (await import("./info-DsuCu_P-.js")).infoSvg,
  exclamationTriangle: async () => (await import("./exclamation-triangle-BntseZxI.js")).exclamationTriangleSvg,
  reown: async () => (await import("./reown-logo-DQVMs0Um.js")).reownSvg
};
async function pt(e) {
  if (O.has(e))
    return O.get(e);
