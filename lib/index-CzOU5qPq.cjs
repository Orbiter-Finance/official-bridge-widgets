...
`;var C=function(t,e,r,i){var s=arguments.length,o=s<3?e:i===null?i=Object.getOwnPropertyDescriptor(e,r):i,n;if(typeof Reflect=="object"&&typeof Reflect.decorate=="function")o=Reflect.decorate(t,e,r,i);else for(var a=t.length-1;a>=0;a--)(n=t[a])&&(o=(s<3?n(o):s>3?n(e,r,o):n(e,r))||o);return s>3&&o&&Object.defineProperty(e,r,o),o};const I={add:async()=>(await Promise.resolve().then(()=>require("./add-MzGuYwiP.cjs"))).addSvg,allWallets:async()=>(await Promise.resolve().then(()=>require("./all-wallets-CQXG0mfv.cjs"))).allWalletsSvg,arrowBottomCircle:async()=>(await Promise.resolve().then(()=>require("./arrow-bottom-circle-CSF3CiXD.cjs"))).arrowBottomCircleSvg,appStore:async()=>(await Promise.resolve().then(()=>require("./app-store-CD4q9XHx.cjs"))).appStoreSvg,apple:async()=>(await Promise.resolve().then(()=>require("./apple-BQ2x-iib.cjs"))).appleSvg,arrowBottom:async()=>(await Promise.resolve().then(()=>require("./arrow-bottom-aktFr5KH.cjs"))).arrowBottomSvg,arrowLeft:async()=>(await Promise.resolve().then(()=>require("./arrow-left-CFXVDQun.cjs"))).arrowLeftSvg,arrowRight:async()=>(await Promise.resolve().then(()=>require("./arrow-right-Bf1kXMzI.cjs"))).arrowRightSvg,arrowTop:async()=>(await Promise.resolve().then(()=>require("./arrow-top-CCIl1Qsy.cjs"))).arrowTopSvg,bank:async()=>(await Promise.resolve().then(()=>require("./bank-0JmYzZXC.cjs"))).bankSvg,browser:async()=>(await Promise.resolve().then(()=>require("./browser-FoDpjp9u.cjs"))).browserSvg,card:async()=>(await Promise.resolve().then(()=>require("./card-BZDiIvo_.cjs"))).cardSvg,checkmark:async()=>(await Promise.resolve().then(()=>require("./checkmark-CLMN9_X7.cjs"))).checkmarkSvg,checkmarkBold:async()=>(await Promise.resolve().then(()=>require("./checkmark-bold-BP_SyBm-.cjs"))).checkmarkBoldSvg,chevronBottom:async()=>(await Promise.resolve().then(()=>require("./chevron-bottom-A8yZWNLM.cjs"))).chevronBottomSvg,chevronLeft:async()=>(await Promise.resolve().then(()=>require("./chevron-left-BmR3HcNv.cjs"))).chevronLeftSvg,chevronRight:async()=>(await Promise.resolve().then(()=>require("./chevron-right-U64IJwVd.cjs"))).chevronRightSvg,chevronTop:async()=>(await Promise.resolve().then(()=>require("./chevron-top-GauQXTmL.cjs"))).chevronTopSvg,chromeStore:async()=>(await Promise.resolve().then(()=>require("./chrome-store-CjmgFqjD.cjs"))).chromeStoreSvg,clock:async()=>(await Promise.resolve().then(()=>require("./clock-BxeCH9hB.cjs"))).clockSvg,close:async()=>(await Promise.resolve().then(()=>require("./close-C4HzhH2u.cjs"))).closeSvg,compass:async()=>(await Promise.resolve().then(()=>require("./compass-DWEStNFb.cjs"))).compassSvg,coinPlaceholder:async()=>(await Promise.resolve().then(()=>require("./coinPlaceholder-BNPI8w37.cjs"))).coinPlaceholderSvg,copy:async()=>(await Promise.resolve().then(()=>require("./copy-C-mfjx0k.cjs"))).copySvg,cursor:async()=>(await Promise.resolve().then(()=>require("./cursor-DtBjN78m.cjs"))).cursorSvg,cursorTransparent:async()=>(await Promise.resolve().then(()=>require("./cursor-transparent-FRZ2tMH_.cjs"))).cursorTransparentSvg,desktop:async()=>(await Promise.resolve().then(()=>require("./desktop-DdueNg-B.cjs"))).desktopSvg,disconnect:async()=>(await Promise.resolve().then(()=>require("./disconnect-dchSuXoH.cjs"))).disconnectSvg,discord:async()=>(await Promise.resolve().then(()=>require("./discord-DIKfnto2.cjs"))).discordSvg,etherscan:async()=>(await Promise.resolve().then(()=>require("./etherscan-C7bY7tu3.cjs"))).etherscanSvg,extension:async()=>(await Promise.resolve().then(()=>require("./extension-CKFuxHVA.cjs"))).extensionSvg,externalLink:async()=>(await Promise.resolve().then(()=>require("./external-link-DWz6HLoX.cjs"))).externalLinkSvg,facebook:async()=>(await Promise.resolve().then(()=>require("./facebook-rYCfD_9i.cjs"))).facebookSvg,farcaster:async()=>(await Promise.resolve().then(()=>require("./farcaster-TAfR2ma7.cjs"))).farcasterSvg,filters:async()=>(await Promise.resolve().then(()=>require("./filters-BppiisM7.cjs"))).filtersSvg,github:async()=>(await Promise.resolve().then(()=>require("./github-DqRbA8aT.cjs"))).githubSvg,google:async()=>(await Promise.resolve().then(()=>require("./google-Wxnr1e0x.cjs"))).googleSvg,helpCircle:async()=>(await Promise.resolve().then(()=>require("./help-circle-BxrB9npD.cjs"))).helpCircleSvg,image:async()=>(await Promise.resolve().then(()=>require("./image-BeM4SSRv.cjs"))).imageSvg,id:async()=>(await Promise.resolve().then(()=>require("./id-6wkKJaDw.cjs"))).idSvg,infoCircle:async()=>(await Promise.resolve().then(()=>require("./info-circle-KeMzC2tK.cjs"))).infoCircleSvg,lightbulb:async()=>(await Promise.resolve().then(()=>require("./lightbulb-CQHr8_Xr.cjs"))).lightbulbSvg,mail:async()=>(await Promise.resolve().then(()=>require("./mail-BnTkNP-V.cjs"))).mailSvg,mobile:async()=>(await Promise.resolve().then(()=>require("./mobile-Da9D2O1E.cjs"))).mobileSvg,more:async()=>(await Promise.resolve().then(()=>require("./more-C9IMnTWB.cjs"))).moreSvg,networkPlaceholder:async()=>(await Promise.resolve().then(()=>require("./network-placeholder-CiVTzplq.cjs"))).networkPlaceholderSvg,nftPlaceholder:async()=>(await Promise.resolve().then(()=>require("./nftPlaceholder-Ba7wP99D.cjs"))).nftPlaceholderSvg,off:async()=>(await Promise.resolve().then(()=>require("./off-BDmHftZX.cjs"))).offSvg,playStore:async()=>(await Promise.resolve().then(()=>require("./play-store-D-yAJC6X.cjs"))).playStoreSvg,plus:async()=>(await Promise.resolve().then(()=>require("./plus-DelErH8B.cjs"))).plusSvg,qrCode:async()=>(await Promise.resolve().then(()=>require("./qr-code-CKse5S6b.cjs"))).qrCodeIcon,recycleHorizontal:async()=>(await Promise.resolve().then(()=>require("./recycle-horizontal-CSUUFcbs.cjs"))).recycleHorizontalSvg,refresh:async()=>(await Promise.resolve().then(()=>require("./refresh-CZCrEB1Q.cjs"))).refreshSvg,search:async()=>(await Promise.resolve().then(()=>require("./search-C5mP_yg_.cjs"))).searchSvg,send:async()=>(await Promise.resolve().then(()=>require("./send-3j2NbVyb.cjs"))).sendSvg,swapHorizontal:async()=>(await Promise.resolve().then(()=>require("./swapHorizontal-B5xn6zx8.cjs"))).swapHorizontalSvg,swapHorizontalMedium:async()=>(await Promise.resolve().then(()=>require("./swapHorizontalMedium-Ap8iydty.cjs"))).swapHorizontalMediumSvg,swapHorizontalBold:async()=>(await Promise.resolve().then(()=>require("./swapHorizontalBold-CHEbDEa4.cjs"))).swapHorizontalBoldSvg,swapHorizontalRoundedBold:async()=>(await Promise.resolve().then(()=>require("./swapHorizontalRoundedBold-DirmHF0P.cjs"))).swapHorizontalRoundedBoldSvg,swapVertical:async()=>(await Promise.resolve().then(()=>require("./swapVertical-DpQDPYtt.cjs"))).swapVerticalSvg,telegram:async()=>(await Promise.resolve().then(()=>require("./telegram-CQ5pyZKq.cjs"))).telegramSvg,threeDots:async()=>(await Promise.resolve().then(()=>require("./three-dots-Bccs-VI5.cjs"))).threeDotsSvg,twitch:async()=>(await Promise.resolve().then(()=>require("./twitch-BAOBeZ_c.cjs"))).twitchSvg,twitter:async()=>(await Promise.resolve().then(()=>require("./x-gbEDAC3u.cjs"))).xSvg,twitterIcon:async()=>(await Promise.resolve().then(()=>require("./twitterIcon-C9J0VEXG.cjs"))).twitterIconSvg,verify:async()=>(await Promise.resolve().then(()=>require("./verify-C1MbPbN_.cjs"))).verifySvg,verifyFilled:async()=>(await Promise.resolve().then(()=>require("./verify-filled-OrAiIXQg.cjs"))).verifyFilledSvg,wallet:async()=>(await Promise.resolve().then(()=>require("./wallet-DPQWJNmZ.cjs"))).walletSvg,walletConnect:async()=>(await Promise.resolve().then(()=>require("./walletconnect-BE46I0qa.cjs"))).walletConnectSvg,walletConnectLightBrown:async()=>(await Promise.resolve().then(()=>require("./walletconnect-BE46I0qa.cjs"))).walletConnectLightBrownSvg,walletConnectBrown:async()=>(await Promise.resolve().then(()=>require("./walletconnect-BE46I0qa.cjs"))).walletConnectBrownSvg,walletPlaceholder:async()=>(await Promise.resolve().then(()=>require("./wallet-placeholder-D26wG5Lb.cjs"))).walletPlaceholderSvg,warningCircle:async()=>(await Promise.resolve().then(()=>require("./warning-circle-CKNeLpFD.cjs"))).warningCircleSvg,x:async()=>(await Promise.resolve().then(()=>require("./x-gbEDAC3u.cjs"))).xSvg,info:async()=>(await Promise.resolve().then(()=>require("./info-CGMv-a74.cjs"))).infoSvg,exclamationTriangle:async()=>(await Promise.resolve().then(()=>require("./exclamation-triangle-DycKf9eJ.cjs"))).exclamationTriangleSvg,reown:async()=>(await Promise.resolve().then(()=>require("./reown-logo-B5BJRxa7.cjs"))).reownSvg};async function ne(t){if(j.has(t))return j.get(t);const r=(I[t]??I.copy)();return j.set(t,r),r}let y=class extends l.i$1{constructor(){super(...arguments),this.size="md",this.name="copy",this.color="fg-300",this.aspectRatio="1 / 1"}render(){return this.style.cssText=`
