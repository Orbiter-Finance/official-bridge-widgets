"use strict";Object.defineProperty(exports,Symbol.toStringTag,{value:"Module"});const r=require("./core-Bi6sqoMa.cjs"),c=require("./index-C61OUbet.cjs"),Fn=require("./index-DKhkf_WM.cjs"),Kn=r.i`
  :host {
    position: relative;
