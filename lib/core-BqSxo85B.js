...
class Wu extends EE {
  ...
  async injectModalUi() {
    if (!al && X.isClient()) {
      if (await import("./basic-DoLhuUUD.js"), await import("./w3m-modal-C_e7dQvM.js"), !document.querySelector("w3m-modal")) {
