...
class Wu extends EE {
  ...
  async injectModalUi() {
    if (!al && X.isClient()) {
      if (await import("./basic-nudi5wrx.js"), await import("./w3m-modal-DOIDsjzL.js"), !document.querySelector("w3m-modal")) {
