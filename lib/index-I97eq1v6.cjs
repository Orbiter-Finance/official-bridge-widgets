...
`;var C=function(t,e,r,i){var s=arguments.length,o=s<3?e:i===null?i=Object.getOwnPropertyDescriptor(e,r):i,n;if(typeof Reflect=="object"&&typeof Reflect.decorate=="function")o=Reflect.decorate(t,e,r,i);else for(var a=t.length-1;a>=0;a--)(n=t[a])&&(o=(s<3?n(o):s>3?n(e,r,o):n(e,r))||o);return s>3&&o&&Object.defineProperty(e,r,o),o};const I={add:async()=>(await Promise.resolve().then(()=>require("./add-CRHhxcBx.cjs"))).addSvg,allWallets:async()=>(await Promise.resolve().then(()=>require("./all-wallets-1roBm4pA.cjs"))).allWalletsSvg,arrowBottomCircle:async()=>(await Promise.resolve().then(()=>require("./arrow-bottom-circle-BIvyIYCB.cjs"))).arrowBottomCircleSvg,appStore:async()=>(await Promise.resolve().then(()=>require("./app-store-C6OtHllS.cjs"))).appStoreSvg,apple:async()=>(await Promise.resolve().then(()=>require("./apple-CUZXWhc4.cjs"))).appleSvg,arrowBottom:async()=>(await Promise.resolve().then(()=>require("./arrow-bottom-Cgl8fSIz.cjs"))).arrowBottomSvg,arrowLeft:async()=>(await Promise.resolve().then(()=>require("./arrow-left-B4RhXwOL.cjs"))).arrowLeftSvg,arrowRight:async()=>(await Promise.resolve().then(()=>require("./arrow-right-Cc7Uu8Sg.cjs"))).arrowRightSvg,arrowTop:async()=>(await Promise.resolve().then(()=>require("./arrow-top-4JMIgAwB.cjs"))).arrowTopSvg,bank:async()=>(await Promise.resolve().then(()=>require("./bank-DXzbm5rB.cjs"))).bankSvg,browser:async()=>(await Promise.resolve().then(()=>require("./browser-h7vHoIzu.cjs"))).browserSvg,card:async()=>(await Promise.resolve().then(()=>require("./card-CD99j7dX.cjs"))).cardSvg,checkmark:async()=>(await Promise.resolve().then(()=>require("./checkmark-B-pTbk_s.cjs"))).checkmarkSvg,checkmarkBold:async()=>(await Promise.resolve().then(()=>require("./checkmark-bold-BCmuJOL0.cjs"))).checkmarkBoldSvg,chevronBottom:async()=>(await Promise.resolve().then(()=>require("./chevron-bottom-x4XBrV4-.cjs"))).chevronBottomSvg,chevronLeft:async()=>(await Promise.resolve().then(()=>require("./chevron-left-VlTyKFhv.cjs"))).chevronLeftSvg,chevronRight:async()=>(await Promise.resolve().then(()=>require("./chevron-right-w45hPd6L.cjs"))).chevronRightSvg,chevronTop:async()=>(await Promise.resolve().then(()=>require("./chevron-top-CkMd8NGL.cjs"))).chevronTopSvg,chromeStore:async()=>(await Promise.resolve().then(()=>require("./chrome-store-CfRPw4_j.cjs"))).chromeStoreSvg,clock:async()=>(await Promise.resolve().then(()=>require("./clock-Bc58vU_Y.cjs"))).clockSvg,close:async()=>(await Promise.resolve().then(()=>require("./close-DsL-KyTl.cjs"))).closeSvg,compass:async()=>(await Promise.resolve().then(()=>require("./compass-DxiH0G6r.cjs"))).compassSvg,coinPlaceholder:async()=>(await Promise.resolve().then(()=>require("./coinPlaceholder-DO-xImEn.cjs"))).coinPlaceholderSvg,copy:async()=>(await Promise.resolve().then(()=>require("./copy-0zbjQ7eD.cjs"))).copySvg,cursor:async()=>(await Promise.resolve().then(()=>require("./cursor-D8RZqnm8.cjs"))).cursorSvg,cursorTransparent:async()=>(await Promise.resolve().then(()=>require("./cursor-transparent-Bhpk18My.cjs"))).cursorTransparentSvg,desktop:async()=>(await Promise.resolve().then(()=>require("./desktop-DYaNXNCK.cjs"))).desktopSvg,disconnect:async()=>(await Promise.resolve().then(()=>require("./disconnect-CQWbXsTX.cjs"))).disconnectSvg,discord:async()=>(await Promise.resolve().then(()=>require("./discord-Beh3ITIu.cjs"))).discordSvg,etherscan:async()=>(await Promise.resolve().then(()=>require("./etherscan-DEUjwRqf.cjs"))).etherscanSvg,extension:async()=>(await Promise.resolve().then(()=>require("./extension-CdjOYOXm.cjs"))).extensionSvg,externalLink:async()=>(await Promise.resolve().then(()=>require("./external-link-CuxBp-eG.cjs"))).externalLinkSvg,facebook:async()=>(await Promise.resolve().then(()=>require("./facebook-CW18Troc.cjs"))).facebookSvg,farcaster:async()=>(await Promise.resolve().then(()=>require("./farcaster-B5Md6_oO.cjs"))).farcasterSvg,filters:async()=>(await Promise.resolve().then(()=>require("./filters-CFcTtZBN.cjs"))).filtersSvg,github:async()=>(await Promise.resolve().then(()=>require("./github-DffJ9k0b.cjs"))).githubSvg,google:async()=>(await Promise.resolve().then(()=>require("./google-DkwF0bAB.cjs"))).googleSvg,helpCircle:async()=>(await Promise.resolve().then(()=>require("./help-circle-COMX1kwT.cjs"))).helpCircleSvg,image:async()=>(await Promise.resolve().then(()=>require("./image-B24CijV7.cjs"))).imageSvg,id:async()=>(await Promise.resolve().then(()=>require("./id-SdPInUxU.cjs"))).idSvg,infoCircle:async()=>(await Promise.resolve().then(()=>require("./info-circle-DxCITBu0.cjs"))).infoCircleSvg,lightbulb:async()=>(await Promise.resolve().then(()=>require("./lightbulb-CRvTt2Pw.cjs"))).lightbulbSvg,mail:async()=>(await Promise.resolve().then(()=>require("./mail-Bk-m-K5z.cjs"))).mailSvg,mobile:async()=>(await Promise.resolve().then(()=>require("./mobile-DyA8uid1.cjs"))).mobileSvg,more:async()=>(await Promise.resolve().then(()=>require("./more-DnLgVH1Z.cjs"))).moreSvg,networkPlaceholder:async()=>(await Promise.resolve().then(()=>require("./network-placeholder-Cwf4rS1E.cjs"))).networkPlaceholderSvg,nftPlaceholder:async()=>(await Promise.resolve().then(()=>require("./nftPlaceholder-D3Aazua3.cjs"))).nftPlaceholderSvg,off:async()=>(await Promise.resolve().then(()=>require("./off-C-M5sxXo.cjs"))).offSvg,playStore:async()=>(await Promise.resolve().then(()=>require("./play-store-CJ_HyAO0.cjs"))).playStoreSvg,plus:async()=>(await Promise.resolve().then(()=>require("./plus-3eg6g_dH.cjs"))).plusSvg,qrCode:async()=>(await Promise.resolve().then(()=>require("./qr-code-2n1V03uU.cjs"))).qrCodeIcon,recycleHorizontal:async()=>(await Promise.resolve().then(()=>require("./recycle-horizontal-BE6qjeQW.cjs"))).recycleHorizontalSvg,refresh:async()=>(await Promise.resolve().then(()=>require("./refresh-CNErACh9.cjs"))).refreshSvg,search:async()=>(await Promise.resolve().then(()=>require("./search-DwZqTCOe.cjs"))).searchSvg,send:async()=>(await Promise.resolve().then(()=>require("./send-BpPfcjR4.cjs"))).sendSvg,swapHorizontal:async()=>(await Promise.resolve().then(()=>require("./swapHorizontal-CJ4i51yG.cjs"))).swapHorizontalSvg,swapHorizontalMedium:async()=>(await Promise.resolve().then(()=>require("./swapHorizontalMedium-21_dvdes.cjs"))).swapHorizontalMediumSvg,swapHorizontalBold:async()=>(await Promise.resolve().then(()=>require("./swapHorizontalBold-lKCFcx7G.cjs"))).swapHorizontalBoldSvg,swapHorizontalRoundedBold:async()=>(await Promise.resolve().then(()=>require("./swapHorizontalRoundedBold-ByTr6msB.cjs"))).swapHorizontalRoundedBoldSvg,swapVertical:async()=>(await Promise.resolve().then(()=>require("./swapVertical-EB_bxAZE.cjs"))).swapVerticalSvg,telegram:async()=>(await Promise.resolve().then(()=>require("./telegram-vPiJZr76.cjs"))).telegramSvg,threeDots:async()=>(await Promise.resolve().then(()=>require("./three-dots-BhS_S1y6.cjs"))).threeDotsSvg,twitch:async()=>(await Promise.resolve().then(()=>require("./twitch-BDx4WgXb.cjs"))).twitchSvg,twitter:async()=>(await Promise.resolve().then(()=>require("./x-Bh7Q-Fpa.cjs"))).xSvg,twitterIcon:async()=>(await Promise.resolve().then(()=>require("./twitterIcon-CZics78j.cjs"))).twitterIconSvg,verify:async()=>(await Promise.resolve().then(()=>require("./verify-BzOHLNiL.cjs"))).verifySvg,verifyFilled:async()=>(await Promise.resolve().then(()=>require("./verify-filled-BPW6vnCx.cjs"))).verifyFilledSvg,wallet:async()=>(await Promise.resolve().then(()=>require("./wallet-v_4o7NEJ.cjs"))).walletSvg,walletConnect:async()=>(await Promise.resolve().then(()=>require("./walletconnect-Co-nhxp_.cjs"))).walletConnectSvg,walletConnectLightBrown:async()=>(await Promise.resolve().then(()=>require("./walletconnect-Co-nhxp_.cjs"))).walletConnectLightBrownSvg,walletConnectBrown:async()=>(await Promise.resolve().then(()=>require("./walletconnect-Co-nhxp_.cjs"))).walletConnectBrownSvg,walletPlaceholder:async()=>(await Promise.resolve().then(()=>require("./wallet-placeholder-B_OobNN7.cjs"))).walletPlaceholderSvg,warningCircle:async()=>(await Promise.resolve().then(()=>require("./warning-circle-DuL9GreX.cjs"))).warningCircleSvg,x:async()=>(await Promise.resolve().then(()=>require("./x-Bh7Q-Fpa.cjs"))).xSvg,info:async()=>(await Promise.resolve().then(()=>require("./info-BDjp0JhQ.cjs"))).infoSvg,exclamationTriangle:async()=>(await Promise.resolve().then(()=>require("./exclamation-triangle-Bup4hOeq.cjs"))).exclamationTriangleSvg,reown:async()=>(await Promise.resolve().then(()=>require("./reown-logo-BpIQ68E0.cjs"))).reownSvg};async function ne(t){if(j.has(t))return j.get(t);const r=(I[t]??I.copy)();return j.set(t,r),r}let y=class extends l.i$1{constructor(){super(...arguments),this.size="md",this.name="copy",this.color="fg-300",this.aspectRatio="1 / 1"}render(){return this.style.cssText=`
