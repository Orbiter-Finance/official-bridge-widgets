...
export class I18n {
  ...
  private flattenTranslation(translationObject: GenericTranslationObject, locale: string): GenericTranslationObject {
    const result: GenericTranslationObject = {}

    const flatten = (currentTranslationObj: GenericTranslationObject, parentKey: string) => {
  ...
  private translateWithReplacements(translation: string, replacements: Record<string, string | undefined> = {}) {
  ...
  public t(key: string, replacements?: Record<string, string | undefined>, options?: TranslationOptions): string {
  ...
  public setTranslations(locale: string, translations: GenericTranslationObject) {
