export function scaleToNativeTokenDecimals({ amount, decimals }: { amount: bigint; decimals: number }) {
...
export function nativeTokenDecimalsTo18Decimals({ amount, decimals }: { amount: bigint; decimals: number }) {
  if (decimals < 18) {
