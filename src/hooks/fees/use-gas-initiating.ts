...
export const useGasInitiating = (
    _: RouteResultDto | null,
    chain: ChainDto | null,
    initiatingItem: GasEstimateRpcParams | null
) => {
    ...
    return {
        data: gasLimitQuery.data ? Number(gasLimitQuery.data) : TRANSFER_GAS,
